...
from zope.interface.tests import (
    MissingSomeAttrs,
...
class NamedTests(unittest.TestCase):
    ...
    def test_class(self):
        ...
        self.assertEqual(Foo.__component_name__,
...
class DeclarationTests(EmptyDeclarationTests):
    ...
    def test___add___overlapping_interface(self):
        ...
        # the other way).
        from zope.interface import Interface, ro
        from zope.interface.interface import InterfaceClass
    ...
    def test___add___overlapping_interface_implementedBy(self):
        ...
        # correct.
        from zope.interface import Interface, implementedBy, implementer, ro
        from zope.interface.tests.test_ro import C3Setting
...
class Test_implementedByFallback(unittest.TestCase):
    ...
    def test_builtins_added_to_cache(self):
        ...
        with _MonkeyDict(declarations, "BuiltinImplementationSpecifications") as specs:
            ...
            for typ in (tuple, list, dict):
                ...
                self.assertEqual(
                    repr(spec), "classImplements(%s)" % (typ.__name__,))
    ...
    def test_w_None_no_bases_w_factory(self):
        ...
        self.assertEqual(
            spec.__name__, "zope.interface.tests.test_declarations.foo")
...
class Test_classImplements(_ImplementsTestMixin, unittest.TestCase):
    ...
    def _callFUT(self, cls, iface):
        ...
        result = classImplements(
            cls, iface)  # pylint:disable=assignment-from-no-return
    ...
    def test_redundant_implementer_Interface(self):
        from zope.interface import Interface, implementedBy, ro
        from zope.interface.tests.test_ro import C3Setting
...
class Test__implements_advice(unittest.TestCase):
    ...
    def test_no_existing_implements(self):
        ...
        self.assertEqual(list(Foo.__implemented__), [
                         IFoo])  # pylint:disable=no-member
...
class TestProvidesClassRepr(unittest.TestCase):
    ...
    def test__repr__directlyProvides_module(self):
        ...
        from zope.interface.declarations import alsoProvides, directlyProvides
        from zope.interface.interface import InterfaceClass
        from zope.interface.tests import dummy
    ...
    def test__repr__providedBy_from_class(self):
        from zope.interface.declarations import implementer, providedBy
        from zope.interface.interface import InterfaceClass
    ...
    def test__repr__providedBy_alsoProvides(self):
        from zope.interface.declarations import alsoProvides, implementer, providedBy
        from zope.interface.interface import InterfaceClass
...
class Test_directlyProvides(unittest.TestCase):
    ...
    def test_w_class(self):
        ...
        self.assertEqual(list(Foo.__provides__), [
                         IFoo])  # pylint:disable=no-member
...
class Test_alsoProvides(unittest.TestCase):
    ...
    def test_w_existing_provides(self):
        from zope.interface.declarations import ProvidesClass, directlyProvides
        from zope.interface.interface import InterfaceClass
...
class TestClassProvidesRepr(unittest.TestCase):
    ...
    def test__repr__providing_one(self):
        ...
        self.assertEqual(
            repr(inst), "directlyProvides(TestClassProvidesRepr, IFoo)")
...
class ObjectSpecificationDescriptorFallbackTests(unittest.TestCase):
    ...
    def test_accessed_via_inst_wo_provides(self):
        from zope.interface.declarations import Provides, implementer
        from zope.interface.interface import InterfaceClass
    ...
    def test_accessed_via_inst_w_provides(self):
        from zope.interface.declarations import Provides, directlyProvides, implementer
        from zope.interface.interface import InterfaceClass
