...
class ComponentsTests(unittest.TestCase):
    ...
    def test_registerAdapter_w_required_containing_None(self):
        ...
        self.assertIs(comp.adapters._adapters[1][Interface][ifoo][_name], _Factory)
        self.assertEqual(
    ...
    def test_registerAdapter_w_required_containing_class(self):
        from zope.interface.declarations import (InterfaceClass, implementedBy,
                                                 implementer)
        from zope.interface.interfaces import Registered
        from zope.interface.registry import AdapterRegistration
        ...
        self.assertIs(comp.adapters._adapters[1][_ctx_impl][ifoo][_name], _Factory)
        self.assertEqual(
    ...
    def test_queryAdapter_miss_w_default(self):
        ...
        _context = object()
        _default = object()
        self.assertIs(comp.queryAdapter(_context, ifoo, default=_default), _default)
    ...
    def test_rebuildUtilityRegistryFromLocalCache(self):
        ...
        self.assertEqual(len(new_subs[0][IFoo][""]), len(orig_subscribers[0][IFoo][""]))
