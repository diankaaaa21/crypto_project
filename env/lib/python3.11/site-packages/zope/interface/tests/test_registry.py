...
class ComponentsTests(unittest.TestCase):
    ...
    def test_registerUtility_with_component_name(self):
        from zope.interface.declarations import InterfaceClass, named
        ...
        self.assertEqual(
            comp._utility_registrations[ifoo, "foo"], (foo, _info, None))
    ...
    def test_registerUtility_no_provided_available(self):
        ...
        self.assertRaises(TypeError, comp.registerUtility,
                          _to_reg, None, _name, _info)

    def test_registerUtility_wo_provided(self):
        from zope.interface.declarations import InterfaceClass, directlyProvides
        from zope.interface.interfaces import Registered
        from zope.interface.registry import UtilityRegistration
    ...
    def test_registerUtility_w_different_names_same_component(self):
        ...
        self.assertEqual(
            comp._utility_registrations[(
                ifoo, _name1)], (_other_reg, _info, None)
        )
        self.assertEqual(
    ...
    def test_registerUtility_replaces_existing_reg(self):
        from zope.interface.declarations import InterfaceClass
        from zope.interface.interfaces import Registered, Unregistered
        from zope.interface.registry import UtilityRegistration
    ...
    def test_unregisterUtility_w_existing_subscr_other_component(self):
        ...
        with _monkey:
            comp.unregisterUtility(_to_reg, ifoo, _name2)
        self.assertEqual(
            comp.utilities._subscribers[0][ifoo][""], (_other_reg,))
    ...
    def test_getUtilitiesFor_hit(self):
        ...
        self.assertEqual(
            sorted(comp.getUtilitiesFor(ifoo)), [
    ...
    def test_getAllUtilitiesRegisteredFor_hit(self):
        ...
        comp.registerUtility(_to_reg, ifoo, name=_name2)
        self.assertEqual(
            list(comp.getAllUtilitiesRegisteredFor(ifoo)), [_to_reg])
    ...
    def test_registerAdapter_w_explicit_provided_and_required(self):
        ...
        self.assertIs(comp.adapters._adapters[1][ibar][ifoo][_name], _factory)
        self.assertEqual(
            comp._adapter_registrations[(
                ibar,), ifoo, _name], (_factory, _info)
        )
        self.assertEqual(len(_events), 1)
        args, kw = _events[0]
        (event,) = args
    ...
    def test_registerAdapter_no_provided_available(self):
        ...
        comp = self._makeOne()
        self.assertRaises(
            TypeError, comp.registerAdapter, _Factory, (
                ibar,), name=_name, info=_info
        )

    def test_registerAdapter_wo_explicit_provided(self):
        from zope.interface.declarations import InterfaceClass, implementer
        from zope.interface.interfaces import Registered
        from zope.interface.registry import AdapterRegistration
    ...
    def test_registerAdapter_w_required_containing_None(self):
        ...
        self.assertIs(
            comp.adapters._adapters[1][Interface][ifoo][_name], _Factory)
        self.assertEqual(
            comp._adapter_registrations[(
                Interface,), ifoo, _name], (_Factory, _info)
        )
        self.assertEqual(len(_events), 1)
        args, kw = _events[0]
        (event,) = args
    ...
    def test_registerAdapter_w_required_containing_class(self):
        ...
        self.assertIs(
            comp.adapters._adapters[1][_ctx_impl][ifoo][_name], _Factory)
        self.assertEqual(
            comp._adapter_registrations[(
                _ctx_impl,), ifoo, _name], (_Factory, _info)
        )
        self.assertEqual(len(_events), 1)
        args, kw = _events[0]
        (event,) = args
    ...
    def test_registerAdapter_wo_explicit_required(self):
        ...
        _monkey, _events = self._wrapEvents()
        with _monkey:
            comp.registerAdapter(_Factory, provided=ifoo,
    ...
    def test_queryAdapter_miss_w_default(self):
        ...
        _context = object()
        _default = object()
        self.assertIs(comp.queryAdapter(
            _context, ifoo, default=_default), _default)
    ...
    def test_queryMultiAdapter_miss(self):
        ...
        _context2 = _Context2()
        comp = self._makeOne()
        self.assertEqual(comp.queryMultiAdapter(
            (_context1, _context2), ifoo), None)
    ...
    def test_queryMultiAdapter_miss_w_default(self):
        ...
        comp = self._makeOne()
        self.assertIs(
            comp.queryMultiAdapter(
                (_context1, _context2), ifoo, default=_default),
            _default,
        )
    ...
    def test_getMultiAdapter_miss(self):
        ...
        comp = self._makeOne()
        self.assertRaises(
            ComponentLookupError, comp.getMultiAdapter, (
                _context1, _context2), ifoo
        )
    ...
    def test_getAdapters_empty(self):
        ...
        _context2 = _Context2()
        comp = self._makeOne()
        self.assertEqual(list(comp.getAdapters(
            (_context1, _context2), ifoo)), [])
    ...
    def test_rebuildUtilityRegistryFromLocalCache(self):
        ...
        for i in range(30):
            comps.registerUtility(UtilityImplementingFoo(), IFoo, name=f"{i}")
        ...
        self.assertEqual(len(new_subs[0][IFoo][""]), len(
            orig_subscribers[0][IFoo][""]))
...
class UnhashableComponentsTests(ComponentsTests):
    ...
    def _getTargetClass(self):
        ...
        class Components(
            super(UnhashableComponentsTests, self)._getTargetClass(),
            dict,
        ):
            pass
