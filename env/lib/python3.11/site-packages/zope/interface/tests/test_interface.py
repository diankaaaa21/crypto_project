...
class Test_invariant(unittest.TestCase):
    ...
    def test_w_single(self):
        from zope.interface.interface import TAGGED_DATA, invariant
...
class Test_taggedValue(unittest.TestCase):
    ...
    def test_w_single(self):
        from zope.interface.interface import TAGGED_DATA, taggedValue
...
class ElementTests(unittest.TestCase):
    ...
    def test_queryDirectTaggedValue_miss_w_default(self):
        element = self._makeOne()
        self.assertEqual(element.queryDirectTaggedValue(
            "nonesuch", "bar"), "bar")
...
class InterfaceClassTests(unittest.TestCase):
    ...
    def test_ctor_w_attrs_attrib_methods(self):
        from zope.interface.interface import Attribute, fromFunction
    ...
    def test_names_w_all_True_w_bases_simple(self):
        ...
        base = self._makeOne("IBase", attrs=BASE_ATTRS)
        derived = self._makeOne("IDerived", bases=(base,), attrs=DERIVED_ATTRS)
        self.assertEqual(sorted(derived.names(all=True)),
                         ["bar", "baz", "foo"])
...
class InterfaceTests(unittest.TestCase):
    ...
    def test_names_derived(self):
        ...
        self.assertEqual(
            sorted(IDerived.names(all=True)), [
    ...
    def test_invariant_simple(self):
        from zope.interface import Attribute, Interface, directlyProvides, invariant
        ...
        # the tests
        self.assertEqual(IInvariant.getTaggedValue(
            "invariants"), [_ifFooThenBar])
    ...
    def test_taggedValue(self):
        from zope.interface import Attribute, Interface, taggedValue
    ...
    def _make_taggedValue_tree(self, base):
        from zope.interface import Attribute, taggedValue
    ...
    def test___call___w_overridden_adapt(self):
        from zope.interface import Interface, implementer, interfacemethod
...
class MethodTests(AttributeTests):
    ...
    def test__repr__w_interface(self):
        ...
        self.assertTrue(r.startswith(
            "<zope.interface.interface.Method object at"), r)
        self.assertTrue(
