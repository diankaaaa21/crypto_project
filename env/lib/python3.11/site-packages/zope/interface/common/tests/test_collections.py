...
from . import VerifyClassMixin, VerifyObjectMixin, add_abc_interface_tests
...
class TestVerifyClass(VerifyClassMixin, unittest.TestCase):
    ...
    def test_UserList(self):
        self.assertTrue(self.verify(
            collections.IMutableSequence, collections.UserList))

    def test_UserDict(self):
        self.assertTrue(self.verify(
            collections.IMutableMapping, collections.UserDict))

    def test_UserString(self):
        self.assertTrue(self.verify(
            collections.ISequence, collections.UserString))
