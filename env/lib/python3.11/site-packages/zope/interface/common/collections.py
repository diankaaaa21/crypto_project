...
from collections import OrderedDict, UserDict, UserList, UserString, abc

from zope.interface._compat import PY313_OR_OLDER
from zope.interface.common import ABCInterface, optional
...
class ICollection(ISized, IIterable, IContainer):
    abc = _new_in_ver(
        "Collection", True, (ISized.getABC(),
                             IIterable.getABC(), IContainer.getABC())
    )
