...
class Components:
    ...
    def unregisterUtility(self, component=None, provided=None, name="", factory=None):
        ...
        notify(
            Unregistered(UtilityRegistration(
                self, provided, name, component, *old[1:]))
        )
    ...
    def unregisterAdapter(
        ...
        notify(Unregistered(AdapterRegistration(
            self, required, provided, name, *old)))
    ...
    def registerHandler(self, factory, required=None, name="", info="", event=True):
        ...
        if event:
            notify(Registered(HandlerRegistration(
                self, required, name, factory, info)))
    ...
    def unregisterHandler(self, factory=None, required=None, name=""):
        ...
        notify(Unregistered(HandlerRegistration(
