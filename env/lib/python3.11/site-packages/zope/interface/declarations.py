...
class Declaration(Specification):
    ...
    def _add_interfaces_to_cls(interfaces, cls):
        ...
        interfaces = tuple(
            [iface for iface in interfaces if not implemented_by_cls.isOrExtends(
                iface)]
        )
...
class Provides(Declaration):  # Really named ProvidesClass
    ...
    def __repr__(self):
        ...
        if providing_on_module:
            ...
            ordered_names = (f"{mod_names}, ") + ordered_names
        return "{}({})".format(
            function_name,
            ordered_names,
        )
...
def moduleProvides(*interfaces):
    ...
    p = locals["__provides__"] = Provides(
        ModuleType, *_normalizeargs(interfaces))
