...
from zope.interface.exceptions import BrokenImplementation, InvalidInterface
from zope.interface.declarations import implementedBy, providedBy
import sys
import weakref
...
class Specification(SpecificationBase):
    ...
    def _calculate_sro(self):
        ...
        sro = self._do_calculate_ro(
            base_mros={b: b.__sro__ for b in self.__bases__})
        root = self._ROOT
    ...
    def changed(self, originally_changed):
        ...
        self.__iro__ = tuple(
            [ancestor for ancestor in ancestors if isinstance(
                ancestor, InterfaceClass)]
        )
