...
class PromptSession(Generic[_T]):
    ...
    def _create_layout(self) -> Layout:
        ...
        all_input_processors = [
            ...
            DynamicProcessor(lambda: merge_processors(
                self.input_processors or [])),
            ConditionalProcessor(
    ...
    def _create_prompt_bindings(self) -> KeyBindings:
        ...
        def _keyboard_interrupt(event: E) -> None:
            ...
            event.app.exit(exception=self.interrupt_exception(),
        ...
        def _eof(event: E) -> None:
            ...
            event.app.exit(exception=self.eof_exception(),
                           style="class:exiting")
    ...
    def _dumb_prompt(self, message: AnyFormattedText = "") -> Iterator[Application[_T]]:
        ...
        self.output.write(fragment_list_to_text(
            to_formatted_text(self.message)))
        self.output.flush()
