            ...
            if from_ == 0 and to == 0 and len(fragments) == 0:
                ...
                for i in range(from_, to):
                    if i < len(fragments):
                        ...
                        fragments[i] = (
                            old_fragment + selected_fragment, old_text)
...
class BeforeInput(Processor):
    ...
    def apply_transformation(self, ti: TransformationInput) -> Transformation:
        ...
        if ti.lineno == 0:
            ...
            def source_to_display(i): return i + shift_position
            def display_to_source(i): return i - shift_position
        else:
