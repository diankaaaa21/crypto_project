...
class Win32Output(Output):
    ...
    def cursor_goto(self, row: int = 0, column: int = 0) -> None:
        ...
        self._winapi(
            windll.kernel32.SetConsoleCursorPosition, self.hconsole, _coord_byval(
                pos)
        )
    ...
    def scroll_buffer_to_prompt(self) -> None:
        ...
        # Scroll API
        self._winapi(
            windll.kernel32.SetConsoleWindowInfo, self.hconsole, True, byref(
                result)
        )
    ...
    def enable_mouse_support(self) -> None:
        ...
        original_mode = DWORD()
        self._winapi(windll.kernel32.GetConsoleMode,
                     handle, pointer(original_mode))
        self._winapi(
