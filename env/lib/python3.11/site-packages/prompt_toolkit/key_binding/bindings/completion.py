            ...
            for c in range(column_count):
                try:
                    ...
                    result.extend(to_formatted_text(
                        completion.display, style=style))

                    # Add padding.
                    padding = max_compl_width - \
                        get_cwidth(completion.display_text)
                    result.append((completion.style, " " * padding))
                except IndexError:
                    pass
            result.append(("", "\n"))

        app.print_text(to_formatted_text(
            result, "class:readline-like-completions"))
