...
class RequestHandler(object):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # possible conflicts.
        self.ui["_tt_modules"] = _UIModuleNamespace(
    ...
    # type: Callable[..., Optional[Awaitable[None]]]
    ...
    def on_connection_close(self) -> None:
        ...
        if _has_stream_request_body(self.__class__):
            if not self.request._body_future.done():
                self.request._body_future.set_exception(
    ...
    def xsrf_token(self) -> bytes:
        ...
        if not hasattr(self, "_xsrf_token"):
            ...
            if output_version == 1:
                ...
                raise ValueError(
                    "unknown xsrf cookie version %d", output_version)
            if version is None:
    ...
    def _decode_xsrf_token(
        ...
        try:
            ...
            gen_log.debug(
                "Uncaught exception in _decode_xsrf_token", exc_info=True)
    ...
    def execute(self) -> Optional[Awaitable[None]]:
        ...
        fut = gen.convert_yielded(
            self.handler._execute(
                transforms, *self.path_args, **self.path_kwargs)
        )
    ...
    def get(self, *args: Any, **kwargs: Any) -> None:
        ...
        if self.request.query_arguments:
            ...
            to_url = httputil.url_concat(
                to_url,
                # type: ignore
                list(httputil.qs_to_qsl(self.request.query_arguments)),
            )
    ...
    async def get(self, path: str, include_body: bool = True) -> None:
        ...
        if request_range:
            ...
            if size != (end or size) - (start or 0):
                ...
                self.set_header(
                    "Content-Range", httputil._get_content_range(
                        start, end, size)
                )
        else:
            start = end = None
