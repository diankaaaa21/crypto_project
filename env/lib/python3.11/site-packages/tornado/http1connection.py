...
import re
import types
from typing import Awaitable, Callable, Optional, Tuple, Type, Union, cast
...
class HTTP1Connection(httputil.HTTPConnection):
    ...
    def __init__(
        ...
        # type: Optional[httputil.RequestStartLine]
        self._request_start_line = None
        # type: Optional[httputil.ResponseStartLine]
    ...
    def write_headers(
        ...
        if self.is_client:
            ...
            lines.append(utf8("%s %s HTTP/1.1" %
            ...
            lines.append(utf8("HTTP/1.1 %d %s" %
    ...
    def _read_body(
        ...
        if "Content-Length" in headers:
            ...
            try:
                content_length: Optional[int] = parse_int(
                    headers["Content-Length"])
            except ValueError:
