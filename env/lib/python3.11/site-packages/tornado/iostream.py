...
_ERRNO_CONNRESET = (errno.ECONNRESET, errno.ECONNABORTED,
...
class BaseIOStream(object):
    ...
    def __init__(
        ...
        # spurious failures.
        self.read_chunk_size = min(
            read_chunk_size or 65536, self.max_buffer_size // 2)
            ...
            if self._read_buffer:
                ...
                if loc != -1:
                    ...
                    self._check_max_bytes(
                        self._read_delimiter, loc + delimiter_len)
                    return loc + delimiter_len
                self._check_max_bytes(
                    self._read_delimiter, self._read_buffer_size)
