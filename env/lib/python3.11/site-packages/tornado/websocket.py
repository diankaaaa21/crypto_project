...
class WebSocketProtocol13(WebSocketProtocol):
    ...
    def __init__(
        ...
        # type: Optional[_PerMessageDeflateDecompressor]
        self._decompressor = None
    ...
    async def _accept_connection(self, handler: WebSocketHandler) -> None:
        subprotocol_header = handler.request.headers.get(
        ...
        if self.selected_subprotocol:
            ...
            handler.set_header("Sec-WebSocket-Protocol",
        ...
        handler.set_header("Sec-WebSocket-Accept",
                           self._challenge_response(handler))
        handler.finish()
        ...
        try:
            open_result = handler.open(
                *handler.open_args, **handler.open_kwargs)
...
class WebSocketClientConnection(simple_httpclient._HTTPConnection):
    ...
    def __init__(
        ...
        on_message_callback: Optional[Callable[[
            Union[None, str, bytes]], None]] = None,
        compression_options: Optional[Dict[str, Any]] = None,
        ping_interval: Optional[float] = None,
        ping_timeout: Optional[float] = None,
        max_message_size: int = _default_max_message_size,
    ...
    def __del__(self) -> None:
        if self.protocol is not None:
            ...
            warnings.warn("Unclosed WebSocketClientConnection",
                          ResourceWarning)
    ...
    def read_message(
        ...
        callback: Optional[Callable[[
            "Future[Union[None, str, bytes]]"], None]] = None,
    ...
    def log_exception(
        ...
        app_log.error("Uncaught exception %s", value,
...
def websocket_connect(
    ...
    callback: Optional[Callable[[
        "Future[WebSocketClientConnection]"], None]] = None,
