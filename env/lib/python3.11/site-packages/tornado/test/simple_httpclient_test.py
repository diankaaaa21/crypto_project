...
class SimpleHTTPClientTestMixin(object):
    ...
    def test_connection_limit(self: typing.Any):
        with closing(self.create_client(max_clients=2)) as client:
            ...
            self.triggers.popleft()()
            self.wait(condition=lambda: (
                len(self.triggers) == 2 and len(seen) == 2))
    ...
    def test_request_timeout(self: typing.Any):
        ...
        with self.assertRaises(HTTPTimeoutError):
            self.fetch("/trigger?wake=false",
                       request_timeout=timeout, raise_error=True)
    ...
    def test_host_header(self: typing.Any):
        ...
        url = self.get_url("/host_echo").replace("http://",
                                                 "http://me:secret@")
        response = self.fetch(url)
    ...
    def test_connection_refused(self: typing.Any):
        ...
        if sys.platform != "cygwin":
            ...
            self.assertTrue(expected_message in str(
                cm.exception), cm.exception)
