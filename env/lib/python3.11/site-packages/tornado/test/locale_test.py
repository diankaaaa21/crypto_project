...
class TranslationLoaderTest(unittest.TestCase):
    ...
    def test_gettext(self):
        ...
        self.assertEqual(locale.pgettext(
            "organization", "club", "clubs", 1), "le club")
        self.assertEqual(
            locale.pgettext("organization", "club", "clubs", 2), "les clubs"
        )
        self.assertEqual(locale.pgettext(
            "stick", "club", "clubs", 1), "le b\xe2ton")
        self.assertEqual(locale.pgettext(
            "stick", "club", "clubs", 2), "les b\xe2tons")
...
class EnglishTest(unittest.TestCase):
    def test_format_date(self):
        ...
        self.assertEqual(
            locale.format_date(
                date, full_format=True), "April 28, 2013 at 6:35 pm"
        )
    ...
    def test_format_day(self):
        locale = tornado.locale.get("en_US")
        date = datetime.datetime(2013, 4, 28, 18, 35)
        self.assertEqual(locale.format_day(
            date=date, dow=True), "Sunday, April 28")
