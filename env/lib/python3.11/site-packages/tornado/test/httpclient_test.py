...
""".replace(
    ...
    def test_basic_auth_unicode(self):
        ...
        self.assertEqual(
            self.fetch("/auth", auth_username="test",
        ...
        self.assertEqual(
            self.fetch("/auth", auth_username=username,
    ...
    def test_redirect_without_location(self):
        response = self.fetch(
            "/redirect_without_location", follow_redirects=True)
    ...
    def test_method_after_redirect(self):
        ...
        for status in [301, 302, 303]:
            ...
            for method in ["GET", "OPTIONS", "PUT", "DELETE"]:
                resp = self.fetch(url, method=method,
                                  allow_nonstandard_methods=True)
    ...
    def test_configure_defaults(self):
        ...
        client = self.http_client.__class__(
...
""".replace(
    ...
    def test_response_times(self):
        ...
        for k, v in response.time_info.items():
            self.assertTrue(
                0 <= v < 1.0, "time_info[%s] out of bounds: %s" % (k, v))
    ...
    def test_both_set(self):
        proxy = _RequestProxy(
            HTTPRequest("http://example.com/",
                        proxy_host="foo"), dict(proxy_host="bar")
        )
