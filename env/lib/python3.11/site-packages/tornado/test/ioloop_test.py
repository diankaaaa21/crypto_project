...
class TestIOLoop(AsyncTestCase):
    def test_add_callback_return_sequence(self):
        ...
        loop.add_callback = types.MethodType(
            add_callback, loop)  # type: ignore
    ...
    def test_remove_timeout_cleanup(self):
        ...
        for i in range(2000):
            timeout = self.io_loop.add_timeout(
                self.io_loop.time() + 3600, lambda: None)
    ...
    def test_timeout_with_arguments(self):
        ...
        self.io_loop.add_timeout(
            datetime.timedelta(seconds=0), results.append, 2)
    ...
    def test_close_file_object(self):
        ...
        io_loop = IOLoop()
        io_loop.add_handler(socket_wrapper, lambda fd,
                            events: None, IOLoop.READ)
    ...
    def test_handler_callback_file_object(self):
        ...
        self.io_loop.add_handler(server_sock.fileno(),
                                 handle_connection, IOLoop.READ)
        with contextlib.closing(socket.socket()) as client_sock:
            client_sock.connect(("127.0.0.1", port))
            self.wait()
...
class TestPeriodicCallbackMath(unittest.TestCase):
    ...
    def test_clock_backwards(self):
        ...
        self.assertEqual(
            self.simulate_calls(pc, [-2, -1, -3, -2, 0]
        ...
        # ignored.
        self.assertEqual(self.simulate_calls(
            pc, [-100, 0, 0]), [1010, 1020, 1030])
    ...
    def test_timedelta(self):
        pc = PeriodicCallback(
            lambda: None, datetime.timedelta(minutes=1, seconds=23))
