...
three{%end%}
    ...
    def test_error_line_number_include(self):
        ...
        try:
            ...
            self.assertTrue(
                "# sub.html:1 (via base.html:1)" in traceback.format_exc())
...
{% end %}
        ...
        try:
            ...
            self.assertTrue(
                "# sub.html:4 (via base.html:1)" in traceback.format_exc())
...
class ParseErrorDetailTest(unittest.TestCase):
    def test_details(self):
        ...
        self.assertEqual(
            "Missing end expression }} at foo.html:3", str(cm.exception))
...
raw: {% raw name %}""",
    ...
    def test_default_off(self):
        ...
        name = "Bobby <table>s"
        self.assertEqual(
            loader.load("escaped.html").generate(
                name=name), b"Bobby &lt;table&gt;s"
        )
        self.assertEqual(
            loader.load("unescaped.html").generate(
                name=name), b"Bobby <table>s"
        )
        self.assertEqual(
    ...
    def test_default_on(self):
        ...
        self.assertEqual(
            loader.load("default.html").generate(
                name=name), b"Bobby &lt;table&gt;s"
        )
    ...
    def test_unextended_block(self):
        ...
        self.assertEqual(
            loader.load("unescaped_block.html").generate(
                name=name), b"base: <script>"
        )
    ...
    def test_extended_block(self):
        ...
        self.assertEqual(
            render("escaped_extends_unescaped.html"), b"base: <script>")
        self.assertEqual(
...
%}"""
    ...
    def test_whitespace_by_filename(self):
        ...
        self.assertEqual(loader.load(
            "include.html").generate(), b" \t    zxcv\n\n\n")
        self.assertEqual(loader.load(
            "include.txt").generate(), b"\t\t\nasdf     ")
...
class TemplateLoaderTest(unittest.TestCase):
    def setUp(self):
        self.loader = Loader(os.path.join(
