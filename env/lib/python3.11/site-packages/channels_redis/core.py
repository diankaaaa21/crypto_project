...
class RedisChannelLayer(BaseChannelLayer):
    ...
    def _setup_encryption(self, symmetric_encryption_keys):
        ...
        if symmetric_encryption_keys:
            ...
            sub_fernets = [self.make_fernet(key)
                           for key in symmetric_encryption_keys]
                    ...
                    if message or exception:
                        ...
                        try:
                            ...
                            if isinstance(message_channel, list):
                                ...
                                self.receive_buffer[message_channel].put_nowait(
                                    message)
                            message = None
                        except Exception:
                            del self.receive_buffer[channel]
    ...
    async def receive_single(self, channel):
        ...
        """
        # Check channel name
        assert self.valid_channel_name(
            channel, receive=True), "Channel name invalid"
    ...
    async def group_send(self, group, message):
        ...
        for connection_index, channel_redis_keys in connection_to_channel_keys.items():
            ...
            channels_over_capacity = await connection.eval(
                group_send_lua, len(channel_redis_keys), *
