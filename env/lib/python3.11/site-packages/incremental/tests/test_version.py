...
class VersionsTests(TestCase):
    ...
    def test_NEXTMustBeAlone(self):
        ...
        with self.assertRaises(ValueError):
            Version("whatever", "NEXT", 1, 0,
                    release_candidate=0, post=0, dev=0)

        with self.assertRaises(ValueError):
            Version("whatever", "NEXT", 0, 1,
                    release_candidate=0, post=0, dev=0)

        with self.assertRaises(ValueError):
            Version("whatever", "NEXT", 0, 0,
                    release_candidate=1, post=0, dev=0)

        with self.assertRaises(ValueError):
            Version("whatever", "NEXT", 0, 0,
                    release_candidate=0, post=1, dev=0)

        with self.assertRaises(ValueError):
            Version("whatever", "NEXT", 0, 0,
                    release_candidate=0, post=0, dev=1)
    ...
    def test_comparingReleaseCandidates(self):
        ...
        self.assertTrue(vb >= va)
        self.assertTrue(va != vb)
        self.assertTrue(vb == Version(
            "whatever", 1, 0, 0, release_candidate=2))
    ...
    def test_comparingDevAndRC(self):
        ...
        self.assertTrue(vb >= va)
        self.assertTrue(va != vb)
        self.assertTrue(vb == Version("whatever", 1, 0,
                        0, release_candidate=1, dev=2))
        self.assertTrue(va == va)
    ...
    def test_reprWithPost(self):
        ...
        """
        self.assertEqual(
            repr(Version("dummy", 1, 2, 3, post=4)
    ...
    def test_reprWithDev(self):
        ...
        """
        self.assertEqual(
            repr(Version("dummy", 1, 2, 3, dev=4)
    ...
    def test_strWithPrerelease(self):
        ...
        """
        self.assertEqual(
            str(Version("dummy", 1, 0, 0, prerelease=1)
    ...
    def test_strWithPost(self):
        ...
        """
        self.assertEqual(
            str(Version("dummy", 1, 0, 0, post=1)
    ...
    def test_getVersionString(self):
        ...
        """
        self.assertEqual("Twisted 8.0.0", getVersionString(
    ...
    def test_getVersionStringWithReleaseCandidate(self):
        ...
        self.assertEqual(
            getVersionString(
                Version("whatever", 8, 0, 0, release_candidate=1)),
            "whatever 8.0.0rc1",
        )
    ...
    def test_getVersionStringWithDev(self):
        ...
        """
        self.assertEqual(
            getVersionString(Version("whatever", 8, 0, 0, dev=1)
                             ), "whatever 8.0.0.dev1"
        )
    ...
    def test_baseWithDevAndRC(self):
        ...
        """
        self.assertEqual(
            Version("foo", 1, 0, 0, release_candidate=2,
                    dev=8).base(), "1.0.0rc2.dev8"
        )
