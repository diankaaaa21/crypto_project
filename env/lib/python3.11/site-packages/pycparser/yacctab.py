...
_lr_productions = [
    ...
    ("pp_directive -> PPHASH", "pp_directive",
     1, "p_pp_directive", "c_parser.py", 569),
    (
        "pppragma_directive -> PPPRAGMA",
        "pppragma_directive",
        1,
    ...
    ("statement -> static_assert", "statement",
     1, "p_statement", "c_parser.py", 640),
    (
        "pragmacomp_or_statement -> pppragma_directive_list statement",
        "pragmacomp_or_statement",
        2,
    ...
    ("block_item -> declaration", "block_item",
     1, "p_block_item", "c_parser.py", 1537),
    ("block_item -> statement", "block_item",
     1, "p_block_item", "c_parser.py", 1538),
    (
        "block_item_list -> block_item",
        "block_item_list",
        1,
    ...
    ("constant -> INT_CONST_DEC", "constant",
     1, "p_constant_1", "c_parser.py", 1842),
    ("constant -> INT_CONST_OCT", "constant",
     1, "p_constant_1", "c_parser.py", 1843),
    ("constant -> INT_CONST_HEX", "constant",
     1, "p_constant_1", "c_parser.py", 1844),
    ("constant -> INT_CONST_BIN", "constant",
     1, "p_constant_1", "c_parser.py", 1845),
    ("constant -> INT_CONST_CHAR", "constant",
     1, "p_constant_1", "c_parser.py", 1846),
    ("constant -> FLOAT_CONST", "constant",
     1, "p_constant_2", "c_parser.py", 1865),
    ("constant -> HEX_FLOAT_CONST", "constant",
     1, "p_constant_2", "c_parser.py", 1866),
    ("constant -> CHAR_CONST", "constant", 1, "p_constant_3", "c_parser.py", 1882),
    ("constant -> WCHAR_CONST", "constant",
     1, "p_constant_3", "c_parser.py", 1883),
    ("constant -> U8CHAR_CONST", "constant",
     1, "p_constant_3", "c_parser.py", 1884),
    ("constant -> U16CHAR_CONST", "constant",
     1, "p_constant_3", "c_parser.py", 1885),
    ("constant -> U32CHAR_CONST", "constant",
     1, "p_constant_3", "c_parser.py", 1886),
    (
        "unified_string_literal -> STRING_LITERAL",
        "unified_string_literal",
        1,
    ...
    ("brace_close -> RBRACE", "brace_close",
     1, "p_brace_close", "c_parser.py", 1931),
