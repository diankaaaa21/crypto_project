...
class WebRequest(http.Request):
        ...
        try:
            ...
            for name, _ in self.requestHeaders.getAllRawHeaders():
                if not HEADER_NAME_RE.fullmatch(name):
                    self.basic_error(400, b"Bad Request",
                                     "Invalid header name")
                    return
            ...
            if self.requestHeaders.hasHeader(b"Upgrade"):
                upgrade_header = self.requestHeaders.getRawHeaders(b"Upgrade")[
                    0]
            ...
            if upgrade_header and upgrade_header.lower() == b"websocket":
                ...
                logger.debug("Upgraded connection %s to WebSocket",
                             self.client_addr)
            ...
            # Boring old HTTP.
                ...
                logger.debug("HTTP %s request for %s",
                             self.method, self.client_addr)
    ...
    def handle_reply(self, message):
        ...
        if message["type"] == "http.response.start":
            ...
            raise ValueError("Cannot handle message type %s!" %
                             message["type"])
    ...
    def handle_exception(self, exception):
        ...
        """
        self.basic_error(500, b"Internal Server Error",
