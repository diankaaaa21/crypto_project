    ...
    def run(self):  # noqa: C901  # is too complex (14)  # FIXME
        ...
        if self.distribution.scripts:
            ...
            self.call_command("install_scripts",
                              install_dir=script_dir, no_ep=1)
        ...
        write_safety_flag(os.path.join(
            archive_root, "EGG-INFO"), self.zip_safe())
...
INSTALL_DIRECTORY_ATTRS = ["install_lib",
                           "install_dir", "install_data", "install_base"]
