...
class PublicAPITests(TestCase):
    def test_emptyDescription(self):
        ...
        self.assertRaises(strcred.InvalidAuthType,
                          strcred.findCheckerFactory, iat)
...
class UnixCheckerTests(TestCase):
    ...
    def test_isChecker(self):
        ...
        self.assertIn(credentials.IUsernamePassword,
                      self.checker.credentialInterfaces)
        self.assertTrue(
            checkers.ICredentialsChecker.providedBy(self.checkerBytes))
        self.assertIn(
    ...
    def test_unixCheckerSucceedsBytes(self):
        ...
        def _gotAvatar(username):
            self.assertEqual(
                username, self.adminBytes.username.decode("utf-8"))
...
class CryptTests(TestCase):
    ...
    def test_verifyCryptedPassword(self):
        ...
        for salt in (None, "ab"):
            ...
            self.assertTrue(cred_unix.verifyCryptedPassword(
                cryptedCorrect, password))
            self.assertFalse(
    ...
    def test_verifyCryptedPasswordOSError(self):
        ...
        self.assertFalse(cred_unix.verifyCryptedPassword(
            cryptedCorrect, password))
...
class CheckerOptionsTests(TestCase):
    ...
    def test_invalidAuthError(self):
        ...
        self.assertRaises(
            usage.UsageError, options.parseOptions, [
                "--auth", invalidParameter]
        )
        self.assertRaises(
            usage.UsageError,
    ...
    def test_unexpectedException(self):
        ...
        self.assertEqual(
            str(err), "Unexpected error: 'file' requires a filename")
...
class LimitingInterfacesTests(TestCase):
    ...
    def test_supportsInterface(self):
        ...
        self.assertTrue(options.supportsInterface(
