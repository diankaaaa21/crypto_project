...
def _percentenc(s): return "".join("%%%02X" % ord(c) for c in s)
...
class TestURL(SynchronousTestCase):
    ...
    def assertURL(
        ...
        expected = (scheme, host, tuple(path), tuple(
            query), fragment, port, u.userinfo)
    ...
    def test_fragmentEquality(self) -> None:
        ...
        self.assertEqual(
            URL.fromText(
                "http://localhost/#"), URL.fromText("http://localhost/")
        )
    ...
    def test_multiChild(self) -> None:
        ...
        """
        self.assertEqual(
            URL.fromText("http://example.com/a/b").child("c",
                                                         "d", "e").asText(),
    ...
    def test_click(self) -> None:
        ...
        self.assertEqual(
            "http://www.foo.com/a/nice/path/?zot=23&zut", urlpath.click(
                "").asText()
        )
        # A simple relative path remove the query.
        self.assertEqual(
            "http://www.foo.com/a/nice/path/click", urlpath.click(
                "click").asText()
        )
        ...
        self.assertEqual(
            "http://www.foo.com/a/nice/path/?burp", urlpath.click(
                "?burp").asText()
        )
        ...
        self.assertEqual(
            "http://www.foo.com/me/17?spam=158", u.click(
                "/me/17?spam=158").asText()
        )
    ...
    def test_queryAdd(self) -> None:
        ...
        self.assertEqual(
            ...
            URL.fromText(
                "http://www.foo.com/a/nice/path/").add("foo", "bar").asText(),
        )
        self.assertEqual(
    ...
    def test_userinfo(self) -> None:
        ...
        self.assertEqual(url.authority(
            True), "someuser:somepassword@example.com")
    ...
    def test_mailto(self) -> None:
        ...
        self.assertEqual(
            URL.fromText(
                "mailto:user@example.com").asText(), "mailto:user@example.com"
        )
