...
class ZipFilePathTests(AbstractFilePathTests):
    ...
    def test_sibling(self) -> None:
        ...
        """
        self.assertEqual(self.path.child("one").sibling(
            "two"), self.path.child("two"))
    ...
    def test_zipPathRepr(self) -> None:
        ...
        """
        child: Union[ZipPath[str, bytes],
                     ZipPath[str, str]] = self.path.child("foo")
        ...
        relativeCommon = self.nativecmn.replace(
            os.getcwd() + os.sep, "", 1) + ".zip"
    ...
    def test_zipArchiveRepr(self) -> None:
        ...
        pathRepr = "ZipArchive({!r})".format(
            os.path.abspath(self.nativecmn + ".zip"))
