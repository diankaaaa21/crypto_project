...
from twisted.logger import Logger as NewLogger
from twisted.logger import LoggingFile
from twisted.logger import LogLevel as NewLogLevel
from twisted.logger import LogPublisher as NewPublisher
from twisted.logger import STDLibLogObserver as NewSTDLibLogObserver
from twisted.logger import globalLogBeginner as newGlobalLogBeginner
from twisted.logger import globalLogPublisher as newGlobalLogPublisher
...
class LogPublisher:
    ...
    def msg(self, *message, **kw):
        ...
        """
        actualEventDict = cast(
            EventDict, (context.get(ILogContext) or {}).copy())
...
def textFromEventDict(eventDict: EventDict) -> Optional[str]:
    ...
    if not edm:
        if eventDict["isError"] and "failure" in eventDict:
            ...
            try:
                traceback = cast(
                    failure.Failure, eventDict["failure"]).getTraceback()
