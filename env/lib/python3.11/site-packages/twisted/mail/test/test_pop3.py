...
class UtilityTests(unittest.SynchronousTestCase):
    ...
    def test_UIDListLineFormatter(self):
        ...
        listLines = list(pop3.formatUIDListResponse(
            [123, 431, 591], uids.__getitem__))
        self.assertEqual(
            listLines, [b"+OK \r\n", b"1 abc\r\n",
                        b"2 def\r\n", b"3 ghi\r\n", b".\r\n"]
        )
...
class AnotherPOP3Tests(unittest.TestCase):
    ...
    def test_authListing(self):
        ...
        p.factory.challengers = {b"Auth1": None,
                                 b"secondAuth": None, b"authLast": None}
        client = LineSendingProtocol(
            [
                b"AUTH",
                b"QUIT",
...
class CapabilityTests(unittest.TestCase):
    ...
    def test_SASL(self):
        ...
        """
        contained(self, b"SASL SCHEME_1 SCHEME_2",
...
class SASLTests(unittest.TestCase):
    ...
    def test_ValidLogin(self):
        ...
        p.factory.challengers = {
            b"CRAM-MD5": cred.credentials.CramMD5Credentials}
...
class IndexErrorCommandTests(CommandMixin, unittest.TestCase):
    ...
    test_LISTWithBadArgument.suppress = [
        _listMessageSuppression]  # type: ignore[attr-defined]
    ...
    test_UIDLWithBadArgument.suppress = [
        _getUidlSuppression]  # type: ignore[attr-defined]
    ...
    test_TOPWithBadArgument.suppress = [
        _listMessageSuppression]  # type: ignore[attr-defined]
    ...
    test_RETRWithBadArgument.suppress = [
        _listMessageSuppression]  # type: ignore[attr-defined]
...
class APOPCredentialsTests(unittest.SynchronousTestCase):
    def test_implementsIUsernamePassword(self):
        ...
        self.assertTrue(verifyClass(
            IUsernameHashedPassword, pop3.APOPCredentials))
