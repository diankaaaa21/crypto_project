...
class DummySMTPMessage:
    ...
    def eomReceived(self):
        ...
        self.protocol.message[tuple(recipients)] = (
            helo, origin, recipients, message)
...
class SMTPHelperTests(TestCase):
    ...
    def testXtextEncoding(self):
        ...
        for case, expected in cases:
            ...
            self.assertEqual(smtp.xtext_decode(
                expected), (case, len(expected)))
    ...
    def test_encodeWithErrors(self):
        ...
        self.assertEqual(
            smtp.xtext_encode(
                text, "strict"), (text.encode("xtext"), len(text))
        )
    ...
    def test_decodeWithErrors(self):
        ...
        self.assertEqual(
            smtp.xtext_decode(
                bytes, "strict"), (bytes.decode("xtext"), len(bytes))
        )
...
class TimeoutTests(TestCase, LoopbackMixin):
    ...
    def _timeoutTest(self, onDone, clientFactory):
        ...
        d = self.assertFailure(
            onDone, smtp.SMTPTimeoutError).addCallback(check)
...
class SMTPSenderFactoryTests(TestCase):
    ...
    def test_removeCurrentProtocolWhenClientConnectionLost(self):
        ...
        clientFactory = smtp.SMTPSenderFactory(
            "source@address", "recipient@address", BytesIO(
                b"message"), sentDeferred
        )
        ...
        clientFactory.clientConnectionLost(
            connector, error.ConnectionDone("Bye."))
...
class SMTPSenderFactoryRetryTests(TestCase):
    ...
    def test_retryAfterDisconnect(self):
        ...
        def cbSent(ignored):
            ...
            """
            self.assertEqual(domain.messages, {
                             recipient: [b"\n" + message + b"\n"]})
...
class NotImplementedDelivery:
    ...
    def validateFrom(self, helo, origin):
        raise NotImplementedError(
            "This oughtn't be called in the course of this test.")
...
class ESMTPAuthenticationTests(TestCase):
    ...
    def test_plainAuthentication(self):
        ...
        self.assertServerResponse(base64.b64encode(
            b"password").strip() + b"\r\n", [])
