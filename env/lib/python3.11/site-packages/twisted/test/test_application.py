...
class InternetTests(TestCase):
    ...
    def testBrokenTimer(self):
        ...
        d.addCallback(
            lambda x: self.assertEqual(
                [ZeroDivisionError],
                [o.value.__class__ for o in self.flushLoggedErrors(
                    ZeroDivisionError)],
            )
        )
        return d
    ...
    def test_reactorParametrizationInClient(self):
        ...
        t.startService()
        self.assertEqual(reactor.tcpClients.pop()[
                         :3], ("127.0.0.1", 1234, factory))
...
class PluggableReactorTests(TwistedModulesMixin, TestCase):
    ...
    def test_getPluginReactorTypes(self):
        ...
        self.assertEqual(self.pluginCalls, [
    ...
    def test_reactorInstallation(self):
        ...
        fakeReactor = FakeReactor(
            install, "fakereactortest", __name__, "described")
        modules = {"fakereactortest": fakeReactor}
        self.replaceSysModules(modules)
        installer = reactors.Reactor(
            "fakereactor", "fakereactortest", "described")
        installer.install()
    ...
    def test_installReactorMultiplePlugins(self):
        ...
        otherReactor = FakeReactor(
            lambda: None, "otherreactor", package, description)
