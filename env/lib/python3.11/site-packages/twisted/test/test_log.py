...
from twisted.logger import ILogObserver, LogBeginner, LoggingFile
from twisted.logger import LogLevel as NewLogLevel
from twisted.logger import LogPublisher as NewLogPublisher
...
class LogTests(unittest.SynchronousTestCase):
    ...
    def test_warningToFile(self) -> None:
        ...
        line = "hello world"
        output = StringIO()
        log.showwarning(message, category, filename,
                        lineno, file=output, line=line)
...
class FileObserverTests(LogPublisherTestCaseMixin, unittest.SynchronousTestCase):
    ...
    def test_timeFormatting(self) -> None:
        ...
        self.flo.getTimezoneOffset = lambda when: - \
            5400  # type: ignore[method-assign]
        ...
        self.flo.getTimezoneOffset = lambda when: - \
            1800  # type: ignore[method-assign]
    ...
    def test_startLoggingOverridesWarning(self) -> None:
        ...
        tempLogPublisher = LogPublisher(
            ...
            logBeginner=LogBeginner(
                newPublisher, StringIO(), SysModule, warnings),
        )
