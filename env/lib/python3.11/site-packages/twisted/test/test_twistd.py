...
class TestLoggerFactory:
    ...
    def start(self, application):
        ...
        self.runner.hadApplicationLogObserver = hasattr(
...
class UnixApplicationRunnerStartApplicationTests(TestCase):
    ...
    def test_setupEnvironment(self):
        ...
        self.patch(UnixApplicationRunner,
                   "setupEnvironment", fakeSetupEnvironment)
        self.patch(UnixApplicationRunner,
                   "shedPrivileges", lambda *a, **kw: None)
        self.patch(app, "startApplication", lambda *a, **kw: None)
        self.runner.startApplication(application)

        self.assertEqual(
            args, ["/foo/chroot", "/foo/rundir", True, 56, "/foo/pidfile"])
    ...
    def test_shedPrivilegesError(self):
        ...
        exc = self.assertRaises(
            SystemExit, runner.shedPrivileges, 35, 200, None)
    ...
    def _setUID(self, wantedUser, wantedUid, wantedGroup, wantedGid, pidFile):
        ...
        """
        patchUserDatabase(self.patch, wantedUser,
                          wantedUid, wantedGroup, wantedGid)
...
class AppLoggerTests(TestCase):
    ...
    def test_configuredLogObserverBeatsSyslog(self):
        ...
        application = Componentized()
        self._checkObserver(
            self._setupConfiguredLogger(
                application, {"syslog": True}, UnixAppLogger)
        )
...
class DaemonizeTests(TestCase):
    ...
    def test_unicodeError(self):
        ...
        """
        self.assertErrorWritten(
            raised="\u2022", reported=b"1 RuntimeError: \\u2022")
...
class ExitWithSignalTests(TestCase):
    ...
    def test_normalExit(self):
        ...
        """
        self.patch(
            twistd, "_SomeApplicationRunner", stubApplicationRunnerFactoryCreator(
                None)
        )
