...
class SystemEventTests(TestCase):
    ...
    def test_unknownPhase(self):
        ...
        """
        eventType = "test"
        self.assertRaises(KeyError, self.addTrigger,
                          "xxx", eventType, lambda: None)
    ...
    def test_removeSystemEventTrigger(self):
        ...
        self.addTrigger("before", eventType, firstBeforeTrigger)
        self.removeTrigger(self.addTrigger(
            "before", eventType, secondBeforeTrigger))
        self.assertEqual(events, [])
        reactor.fireSystemEvent(eventType)
    ...
    def test_removeNonExistentSystemEventTrigger(self):
        ...
        self.assertRaises(
            KeyError, reactor.removeSystemEventTrigger, (
                b[0], ("xxx",) + b[1][1:])
        )
...
class ProducerTests(TestCase):
    ...
    def test_doubleProducer(self):
        ...
        self.assertRaises(RuntimeError, fd.registerProducer,
                          DummyProducer(), 0)
