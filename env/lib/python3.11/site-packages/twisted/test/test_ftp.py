...
class FTPServerTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.factory = ftp.FTPFactory(
            portal=p, userAnonymous=self.userAnonymous)
...
class BasicFTPServerTests(FTPServerTestCase):
    ...
    def test_DecodeHostPort(self):
        ...
        self.assertEqual(
            ftp.decodeHostPort(
                "25,234,129,22,100,23"), ("25.234.129.22", 25623)
        )
        nums = range(6)
        for i in range(6):
            badValue = list(nums)
    ...
    def test_EPSVALLBeforePASV(self):
        ...
        self.assertCommandResponse(
            "EPSV ALL", ["200 EPSV ALL OK"], chainDeferred=d)
        self.assertCommandFailed(
            "PASV",
    ...
    def test_SYST(self):
        ...
        d = self._anonymousLogin()
        self.assertCommandResponse(
            "SYST", ["215 UNIX Type: L8"], chainDeferred=d)
        return d
    ...
    def test_RNFRandRNTO(self):
        ...
        def check_rename(result):
            self.assertTrue(self.dirPath.child(
                self.username).child("bar").exists())
            return result
...
class FTPServerAdvancedClientTests(FTPServerTestCase):
    ...
    def test_anonymousSTOR(self):
        ...
        def eb(res):
            ...
            self.assertEqual(res.value.args[0]
                             [0], "550 foo: Permission denied.")
    ...
    def test_STORtransferErrorIsReturned(self):
        ...
        def eb(res):
            ...
            self.assertEqual(
                res.value.args[0][0], "550 failing_file: is a directory")
    ...
    def test_RETRreadError(self):
        ...
        def check_response(failure):
            ...
            self.assertEqual(
                failure.value.args[0][1], "550 blah: is a directory")
...
class FTPServerPasvDataConnectionTests(FTPServerTestCase):
    ...
    def test_downloadFolder(self):
        ...
        def checkError(failure):
            failure.trap(ftp.CommandFailed)
            self.assertEqual(["550 foo: is a directory"],
...
class FTPServerPortDataConnectionTests(FTPServerPasvDataConnectionTests):
    ...
    def _makeDataConnection(self, ignored=None):
        ...
        cmd = "PORT " + \
            ftp.encodeHostPort("127.0.0.1", dataPort.getHost().port)
    ...
    def test_PORTCannotConnect(self):
        ...
        def loggedIn(ignored):
            ...
            port = reactor.listenTCP(
                0, protocol.Factory(), interface="127.0.0.1")
            portNum = port.getHost().port
...
class FTPFileListingTests(TestCase):
    ...
    def test_OneLine(self):
        ...
        def check(fileOther):
            ...
            self.assertFalse(
                other, f"unexpect unparsable lines: {repr(other)}")
            ...
            self.assertTrue(file["date"] == "Jan 29 03:26",
                            "misparsed fileitem")
    ...
    def test_Year(self):
        ...
        def check(ignored):
            ...
            self.assertTrue(file["size"] == 531, "misparsed fileitem")
            self.assertTrue(file["date"] == "Jan 29 2003",
                            "misparsed fileitem")
            self.assertTrue(file["filename"] == "README", "misparsed fileitem")
...
class FTPRealmTests(TestCase):
    ...
    def test_getHomeDirectory(self):
        ...
        self.assertEqual(filepath.FilePath(
            base).child("alice@example.com"), home)
