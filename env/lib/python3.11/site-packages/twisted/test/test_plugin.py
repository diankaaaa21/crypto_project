    ...
    def test_detectNewFiles(self) -> None:
        ...
        try:
            ...
            self._unimportPythonModule(
                sys.modules["mypackage.pluginextra"], True)
...
class DeveloperSetupTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.systemPackage = _createPluginDummy(
            self.systemPath, pluginFileContents(
                "system"), True, "plugindummy_builtin"
        )
        self.devPackage = _createPluginDummy(
            self.devPath, pluginFileContents(
                "dev"), True, "plugindummy_builtin"
        )
        ...
        now = time.time()
        os.utime(self.sysplug.child(
            "plugindummy_builtin.py").path, (now - 5000,) * 2)
