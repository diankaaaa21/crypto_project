...
class UDPTests(TestCase):
    ...
    def test_sendPackets(self):
        ...
        def cbClientStarted(ignored):
            client.transport.connect(
                "127.0.0.1", server.transport.getHost().port)
    ...
    def test_badConnect(self):
        ...
        client.transport.connect("127.0.0.1", 80)
        self.assertRaises(
            RuntimeError, client.transport.connect, "127.0.0.1", 80)
        return port.stopListening()
...
class MulticastTests(TestCase):
    ...
    def test_joinFailure(self):
        ...
        return self.assertFailure(
            self.client.transport.joinGroup(
                self.invalidGroup), error.MulticastJoinError
        )
    ...
    async def test_multiListen(self) -> None:
        ...
        firstClient.transport.write(
            b"hello world", (self.multicastGroup, portno))
