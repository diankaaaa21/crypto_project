...
class FailureTests(SynchronousTestCase):
    ...
    def assertStartsWith(self, s: str, prefix: str) -> None:
        ...
        self.assertTrue(s.startswith(prefix),
                        f"{prefix!r} is not the start of {s!r}")
    ...
    def assertEndsWith(self, s: str, suffix: str) -> None:
        ...
        self.assertTrue(s.endswith(suffix),
                        f"{suffix!r} is not the end of {s!r}")
    ...
    def test_repr(self) -> None:
        ...
        self.assertEqual(
            repr(f),
            "<twisted.python.failure.Failure " "%s: division by zero>" % (
                typeName,),
        )
...
class ExtendedGeneratorTests(SynchronousTestCase):
    ...
    def _throwIntoGenerator(
        ...
        try:
            ...
            self.fail(
                "throwExceptionIntoGenerator should have raised " "StopIteration")
