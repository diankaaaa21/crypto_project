    ...
    def test_restartListening(self):
        ...
        def cbStopListening(ignored):
            ...
            return defer.gatherResults(
                [serverFactory.protocolConnectionMade,
...
class WriteDataTests(TestCase):
    ...
    def test_writer(self):
        ...
        def check(ignored):
            ...
            self.assertTrue(
                clientF.done, "client didn't see connection dropped")
            expected = b"".join(
        ...
        d = defer.gatherResults(
            [wrappedF.onDisconnect, wrappedClientF.onDisconnect])
...
class AddressTests(TestCase):
    ...
    def setUp(self):
        ...
        self.port = reactor.listenTCP(
            0, self.serverWrapper, interface="127.0.0.1")
...
class HalfCloseTests(TestCase):
    ...
    def setUp(self):
        ...
        d.addCallback(lambda _: self.cf.connectTCP(
    ...
    def testWriteCloseNotification(self):
        ...
        d.addCallback(lambda _: self.assertEqual(
            f.lastProtocol.readHalfClosed, False))
        return d
...
class HalfCloseNoNotificationAndShutdownExceptionTests(TestCase):
    ...
    def testNoNotification(self):
        ...
        d.addCallback(lambda x: self.assertEqual(
            self.f.lastProtocol.data, b"hello"))
