...
class LookupsTests(TestCase):
    ...
    def test_namedClassLookup(self):
        ...
        """
        self.assertIs(reflect.namedClass(
            "twisted.test.test_reflect.Summer"), Summer)
    ...
    def test_namedAnyClassLookup(self):
        ...
        """
        self.assertIs(reflect.namedAny(
            "twisted.test.test_reflect.Summer"), Summer)
    ...
    def test_namedAnySecondAttributeLookup(self):
        ...
        self.assertIs(
            reflect.namedAny(
                "twisted.test.test_reflect." "Summer.reallySet.__doc__"),
    ...
    def test_invalidNames(self):
        ...
        self.assertEqual(
            str(err), "'tcelfer.nohtyp.detsiwt' does not name an object")
...
class ObjectGrepTests(TestCase):
    ...
    def test_boundMethod(self):
        ...
        self.assertIn(".__self__", reflect.objgrep(
            m, m.__self__, reflect.isSame))
        self.assertIn(
            ".__self__.__class__",
            reflect.objgrep(m, m.__self__.__class__, reflect.isSame),
        )
        self.assertIn(".__func__", reflect.objgrep(
            m, m.__func__, reflect.isSame))
    ...
    def test_everything(self):
        ...
        self.assertIn(
            "().__self__.attr[2][0][2]{'Foosh'}", reflect.objgrep(
                w, o, reflect.isSame)
        )
    ...
    def test_depthLimit(self):
        ...
        self.assertEqual(["[0]"], reflect.objgrep(
            d, a, reflect.isSame, maxDepth=1))
        self.assertEqual(
            ["[0]", "[1][0]"], reflect.objgrep(
                d, a, reflect.isSame, maxDepth=2)
        )
        self.assertEqual(
            ["[0]", "[1][0]", "[1][1][0]"],
