...
class TestResult(pyunit.TestResult):
    ...
    expectedFailures: List[Tuple[itrial.ITestCase, str, "Todo"]]
    # type: ignore[assignment]
    unexpectedSuccesses: List[Tuple[itrial.ITestCase, str]]
    successes: int
...
class Reporter(TestResult):
    ...
    def _formatFailureTraceback(self, fail):
        ...
        result = fail.getTraceback(
            detail=self.tbformat, elideFrameworkCode=True)
        fail.frames = frames
        return result
