...
def makeTodo(
    value: Union[
        str, Tuple[Union[Type[BaseException],
                         Iterable[Type[BaseException]]], str]
    ]
) -> Todo:
    """
...
class _Assertions(pyunit.TestCase):
    ...
    def assertIn(self, containee, container, msg=None):
        ...
        if containee not in container:
            raise self.failureException(
                msg or f"{containee!r} not in {container!r}")
        return containee
    ...
    def assertNotIn(self, containee, container, msg=None):
        ...
        if containee in container:
            raise self.failureException(
                msg or f"{containee!r} in {container!r}")
        return containee
    ...
    def assertIsInstance(self, instance, classOrTuple, message=None):
        ...
        if not isinstance(instance, classOrTuple):
            if message is None:
                ...
                suffix = ": " + message
            self.fail(
                f"{instance!r} is not an instance of {classOrTuple}{suffix}")
...
class SynchronousTestCase(_Assertions):
    ...
    def __init__(self, methodName="runTest"):
        ...
        self._parents = [testMethod, self,
                         sys.modules.get(self.__class__.__module__)]
            ...
            for aWarning in self._warnings:
                for aFunction in offendingFunctions:
                    if not isinstance(
                        ...
                        raise ValueError(
                            f"{aFunction!r} is not a function or method")
