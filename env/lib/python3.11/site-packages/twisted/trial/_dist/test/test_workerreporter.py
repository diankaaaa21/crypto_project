...
def run(case: SynchronousTestCase, target: TestCase) -> TestResult:
    ...
    """
    result = TestResult()
    worker, local, pump = connectedServerAndClient(
        LocalWorkerAMP, WorkerProtocol)
...
class WorkerReporterTests(SynchronousTestCase):
    ...
    def test_addErrorGreaterThan64kEncoded(self) -> None:
        ...
        """
        self.assertTestRun(
            erroneous.TestAsynchronousFail(
                "test_exceptionGreaterThan64kEncoded"),
            errors=has_length(1),
        )
    ...
    def test_addErrorTuple(self) -> None:
        ...
        """
        self.assertTestRun(pyunitcases.PyUnitTest(
            "test_error"), errors=has_length(1))
    ...
    def test_addFailureTuple(self) -> None:
        ...
        """
        self.assertTestRun(pyunitcases.PyUnitTest(
            "test_fail"), failures=has_length(1))
