...
class TestFailureTests(pyunit.TestCase):
    ...
    def setUp(self):
        ...
        handling behavior.
        """
        components = [__name__, self.__class__.__name__,
                      self.FailingTest.__name__]
...
class SynchronousAssertionsTests(unittest.SynchronousTestCase):
    ...
    def _testUnequalPair(self, first, second):
        ...
        if not raised:
            self.fail(
                f"Call to assertEqual({first!r}, {second!r}) didn't fail")
    ...
    def test_failUnlessRaises_unexpected(self):
        try:
            ...
            self.fail(
                "failUnlessRaises shouldn't re-raise unexpected " "exceptions")
        except self.failureException:
            # what we expect
            pass
        else:
    ...
    def test_failUnlessIdentical(self):
        ...
        self.assertEqual(
            ret, x, "failUnlessIdentical should return first " "parameter")
        self.failUnlessRaises(self.failureException,
    ...
    def test_failIfAlmostEqual(self):
        ...
        self.assertEqual(
            ret,
            x,
            "failIfAlmostEqual should return " "first parameter (%r, %r)" % (
                ret, x),
        )
        self.failUnlessRaises(
    ...
    def test_assertNotIsInstanceError(self):
        ...
        error = self.assertRaises(
            self.failureException, self.assertNotIsInstance, a, A)
    ...
    def test_assertNotIsInstanceErrorMultipleClasses(self):
        ...
        a = A()
        self.assertRaises(self.failureException,
                          self.assertNotIsInstance, a, (A, B))
...
class WarningAssertionTests(unittest.SynchronousTestCase):
    ...
    def test_assertWarnsOnCall(self):
        ...
        w = Warn()
        r = self.assertWarns(DeprecationWarning,
                             "Egg deprecated", __file__, w, 321)
        self.assertEqual(r, 321)
        r = self.assertWarns(DeprecationWarning,
                             "Egg deprecated", __file__, w, 321)
        self.assertEqual(r, 321)
...
class ResultOfAssertionsTests(unittest.SynchronousTestCase):
    ...
    def test_failureResultOfWithWrongFailure(self):
        ...
        """
        self.assertRaises(
            self.failureException, self.failureResultOf, fail(
                self.failure), KeyError
        )
    ...
    def test_failureResultOfWithExpectedFailureResult(self):
        ...
        self.assertIdentical(
            self.failure,
            self.failureResultOf(fail(self.failure),
                                 self.failure.type, KeyError),
        )
...
class ResultOfCoroutineAssertionsTests(unittest.SynchronousTestCase):
    ...
    def test_failureResultOfWithWrongExceptionOneExpectedExceptionHasTB(self):
        ...
        try:
            ...
            self.assertIn(
                "Failure of type (builtins.KeyError) expected on", str(e))
            self.assertIn("builtins.Exception: Bad times", str(e))
    ...
    def test_failureResultOfWithWrongExceptionMultiExpectedExceptionsHasTB(self):
        ...
        try:
            self.failureResultOf(self.raisesException(
                exception), KeyError, IOError)
        except self.failureException as e:
            self.assertIn(
    ...
    def test_failureResultOfWithException(self):
        ...
        """
        self.assertEqual(
            self.failure.value, self.failureResultOf(
                self.raisesException()).value
        )
...
class CallDeprecatedTests(unittest.SynchronousTestCase):
    ...
    def test_failsWithoutDeprecation(self):
        ...
        self.assertEqual("%r is not deprecated." %
                         notDeprecated, str(exception))
    ...
    def test_nestedDeprecation(self):
        ...
        self.assertEqual(len(warningsShown), 1,
                         f"Unexpected warnings: {warningsShown}")
