...
class SuppressionMixin:
    ...
    def test_suppressClass(self):
        ...
        self.assertEqual(warningsShown[0]["message"],
                         suppression.METHOD_WARNING_MSG)
        self.assertEqual(warningsShown[1]["message"],
                         suppression.MODULE_WARNING_MSG)
    ...
    def test_overrideSuppressClass(self):
        ...
        """
        self.runTests(self._load(self.TestSuppression,
                      "testOverrideSuppressClass"))
        warningsShown = self.flushWarnings([self.TestSuppression._emit])
        self.assertEqual(warningsShown[0]["message"],
                         suppression.METHOD_WARNING_MSG)
        self.assertEqual(warningsShown[1]["message"],
                         suppression.CLASS_WARNING_MSG)
        self.assertEqual(warningsShown[2]["message"],
                         suppression.MODULE_WARNING_MSG)
