...
class FileContentsTests(SynchronousTestCase):
    ...
    def test_matches(self, contents: str, encoding: str) -> None:
        ...
        assert_that(
            fileContents(equal_to(contents)).matches(
                p, description), equal_to(True)
        )
    ...
    def test_mismatches(self, contents: str, encoding: str) -> None:
        ...
        description = StringDescription()
        assert_that(
            fileContents(not_(anything())).matches(
                p, description), equal_to(False)
        )
    ...
    def test_ioerror(self) -> None:
        ...
        description = StringDescription()
        assert_that(fileContents(anything()).matches(
            p, description), equal_to(False))
        assert_that(
            str(description),
