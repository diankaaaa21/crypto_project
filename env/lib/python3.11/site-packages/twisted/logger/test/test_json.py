...
from .._json import log as jsonLog
...
class SaveLoadTests(TestCase):
    ...
    def test_saveLoad(self) -> None:
        ...
        self.assertEqual(
            ...
            eventFromJSON(self.savedEventJSON({1: 2, "3": "4"})),
            {"1": 2, "3": "4"},
        )
    ...
    def test_saveUnPersistableThenFormat(self) -> None:
        ...
        inputEvent = {"log_format": "{object} {object.value}",
                      "object": Reprable(7)}
...
class FileLogObserverTests(TestCase):
    ...
    def assertObserverWritesJSON(self, recordSeparator: str = "\x1e") -> None:
        ...
        with StringIO() as fileHandle:
            ...
            event = dict(x=1)
            observer(event)
            self.assertEqual(fileHandle.getvalue(),
...
class LogFileReaderTests(TestCase):
    ...
    def _readEvents(
        ...
        """
        events = iter(eventsFromJSONLogFile(
            inFile, recordSeparator, bufferSize))
