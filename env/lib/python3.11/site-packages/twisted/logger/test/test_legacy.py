...
class LegacyLogObserverWrapperTests(unittest.TestCase):
    ...
    def test_repr(self) -> None:
        ...
        self.assertEqual(
            repr(observer), "LegacyLogObserverWrapper(<Legacy Observer>)")
    ...
    def observe(self, event: LogEvent) -> LogEvent:
        ...
        legacyObserver = cast(legacyLog.ILogObserver,
...
class PublishToNewObserverTests(unittest.TestCase):
    ...
    def test_isError(self) -> None:
        ...
        publishToNewObserver(
            self.observer, self.legacyEvent(
                isError=1), legacyLog.textFromEventDict
        )
    ...
    def test_system(self) -> None:
        ...
        self.assertEqual(self.events[0]["log_system"],
                         self.events[0]["system"])
