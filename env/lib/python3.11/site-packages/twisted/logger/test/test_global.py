...
class LogBeginnerTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        class NotWarnings:
            def __init__(self) -> None:
                self.warnings: List[
                    Tuple[
                        str, Type[Warning], str, int, Optional[IO[Any]
                                                               ], Optional[int]
                    ]
                ] = []
    ...
    def test_beginLoggingToTwice(self) -> None:
        ...
        self.beginner.beginLoggingTo(
            [cast(ILogObserver, events1.append), textObserver])
        self.publisher(dict(event="postbuffer"))
        secondFilename, secondLine = nextLine()
        self.beginner.beginLoggingTo(
            [cast(ILogObserver, events2.append), textObserver])
    ...
    def test_beginLoggingToRedirectStandardIO(self) -> None:
        ...
        compareEvents(
            self, events, [dict(log_namespace="stdout",
                                log_io="Hello, world.")]
        )
        del events[:]
    ...
    def test_beginLoggingToPreservesEncoding(self) -> None:
        ...
        compareEvents(
            self, events, [dict(log_io="\u674e"), dict(log_io="\u7469")])
