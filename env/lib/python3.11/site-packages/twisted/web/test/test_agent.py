...
class HTTPConnectionPoolTests(TestCase, FakeReactorAndConnectMixin):
    ...
    def test_putStartsTimeout(self):
        ...
        self.assertIn(
            protocol, self.pool._connections[("http", b"example.com", 80)])
    ...
    def test_putExceedsMaxPersistent(self):
        ...
        self.assertEqual(
            pool._connections[("http", b"example.com", 80)], origCached)
        ...
        self.assertEqual(
            [p.transport.disconnecting for p in newCached], [False, False])
    ...
    def test_cancelGetConnectionCancelsEndpointConnect(self):
        ...
        d.cancel()
        self.assertEqual(self.failureResultOf(
            connectionResult).type, CancelledError)
...
class IntegrationTestingMixin:
    ...
    def test_integrationTestIPv6(self):
        ...
        """
        self.integrationTest(b"ipv6.example.com",
                             EXAMPLE_COM_V6_IP, IPv6Address)
    ...
    def integrationTest(
        ...
        clientTransport = FakeTransport(
            clientProtocol, False, peerAddress=peerAddress)
...
class AgentTests(
    ...
    def test_unsupportedScheme(self):
        ...
        return self.assertFailure(
            self.agent.request(
                b"GET", b"mailto:alice@example.com"), SchemeNotSupported
        )
    ...
    def test_hostValueStandardHTTP(self):
        ...
        self.assertEqual(
            self.agent._computeHostValue(
                b"http", b"example.com", 80), b"example.com"
        )
    ...
    def test_hostValueStandardHTTPS(self):
        ...
        self.assertEqual(
            self.agent._computeHostValue(
                b"https", b"example.com", 443), b"example.com"
        )
    ...
    def test_request(self):
        ...
        self.assertEqual(
            ...
            http_headers.Headers(
                {b"foo": [b"bar"], b"host": [b"example.com:1234"]}),
        )
...
class WebClientContextFactoryTests(TestCase):
    ...
    def test_setsTrustRootOnContextToDefaultTrustRoot(self):
        ...
        self.assertIsInstance(certificateOptions.trustRoot,
                              ssl.OpenSSLDefaultPaths)
...
class HTTPConnectionPoolRetryTests(TestCase, FakeReactorAndConnectMixin):
    ...
    def test_wrappedOnPersistentReturned(self):
        ...
        def gotConnection(connection):
            self.assertIsInstance(
                connection, client._RetryingHTTP11ClientProtocol)
    ...
    def retryAttempt(self, willWeRetry):
        ...
        request = client.Request(
            b"FOO", b"/", Headers(), bodyProducer, persistent=True)
        newProtocol()
...
class CookieAgentTests(
    ...
    def test_leaveExistingCookieHeader(self) -> None:
        ...
        req, res = self.protocol.requests.pop()
        self.assertEqual(req.headers.getRawHeaders(
            b"cookie"), [b"already-set"])
...
class ContentDecoderAgentTests(TestCase, FakeReactorAndConnectMixin, AgentTestsMixin):
    ...
    def test_acceptHeaders(self):
        ...
        req, res = protocol.requests.pop()
        self.assertEqual(
            req.headers.getRawHeaders(
                b"accept-encoding"), [b"decoder1,decoder2"]
        )
    ...
    def test_plainEncodingResponse(self):
        ...
        response = Response((b"HTTP", 1, 1), 200, b"OK",
    ...
    def test_unknownEncoding(self):
        ...
        def check(result):
            ...
            self.assertEqual(
                [b"decoder1,fizz"], result.headers.getRawHeaders(
                    b"content-encoding")
            )
...
class _RedirectAgentTestsMixin(testMixinClass):
    ...
    def _testRedirectDefault(
        ...
        host, port = self.reactor.tcpClients.pop()[:2]
        self.assertEqual(
            EXAMPLE_NET_IP if crossDomain else EXAMPLE_COM_IP, host)
        ...
        redirectedElsewhere = self._testRedirectDefault(
            ...
            **crossKwargs,
            requestHeaders=Headers(
                {**sensitiveHeaderValues, **otherHeaderValues}),
        )
    ...
    def test_crossDomainHeaders(self) -> None:
        ...
        self._sensitiveHeadersTest(
            crossDomain=True, expectedHostHeader=b"example.net")
