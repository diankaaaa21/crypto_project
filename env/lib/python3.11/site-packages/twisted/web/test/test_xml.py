...
class Sux0r(sux.XMLParser):
    def __init__(self) -> None:
        self.tokens: list[
            tuple[Literal["start"], str, dict[str, str]
...
class MicroDOMTests(TestCase):
    ...
    def test_tameDocument(self) -> None:
        ...
        self.assertEqual(domhelpers.gatherTextNodes(
            d.documentElement).strip(), "test")
...
alert("I hate you");
    ...
    def test_scriptLeniencyIntelligence(self) -> None:
        ...
        self.assertEqual(
            microdom.parseString(
                s, beExtremelyLenient=1).firstChild().toxml(), s
        )
    ...
    def test_preserveCase(self) -> None:
        ...
        self.assertTrue(d.isEqualToDocument(
            d2), f"{d.toxml()!r} != {d2.toxml()!r}")
        self.assertTrue(d2.isEqualToDocument(
            d3), f"{d2.toxml()!r} != {d3.toxml()!r}")
        ...
        self.assertTrue(d3.isEqualToDocument(
            d4), f"{d3.toxml()!r} != {d4.toxml()!r}")
        self.assertTrue(d4.isEqualToDocument(
            d5), f"{d4.toxml()!r} != {d5.toxml()!r}")
    ...
    def test_CData(self) -> None:
        ...
        self.assertEqual(cdata.cloneNode().toxml(),
                         "<![CDATA[</x>\r\n & foo]]>")
    ...
    def test_children(self) -> None:
        ...
        self.assertEqual([n.nodeName for n in d.childNodes],
                         ["bar", "baz", "bax"])
    ...
    def test_search(self) -> None:
        ...
        self.assertEqual(
            d.getElementsByTagName(
                "foo"), [root, root.lastChild().firstChild()]
        )
    ...
    def test_eatingWhitespace(self) -> None:
        ...
        self.assertTrue(d.isEqualToDocument(
            microdom.parseString("<hello></hello>")))
    ...
    def test_lenientAmpersand(self) -> None:
        ...
        for i, o in [
            ...
            d = microdom.parseString(
                f"{prefix}<pre>{i}</pre>", beExtremelyLenient=1)
    ...
    def test_insensitiveLenient(self) -> None:
        ...
        self.assertEqual(
            d.documentElement.firstChild().toxml(), "<xa><y>c</y></xa>")
    ...
    def test_namespaceInheritance(self) -> None:
        ...
        parent = microdom.Element(
            "div", namespace="http://www.w3.org/1999/xhtml")
...
class BrokenHTMLTests(TestCase):
    ...
    def checkParsed(
        ...
        """
        output = microdom.parseString(
            input, beExtremelyLenient=beExtremelyLenient)
...
class CommentTests(TestCase):
    ...
    def test_isEqualToNode(self) -> None:
        ...
        """
        self.assertTrue(microdom.Comment(
            "foo").isEqualToNode(microdom.Comment("foo")))
        self.assertFalse(microdom.Comment(
            "foo").isEqualToNode(microdom.Comment("bar")))
