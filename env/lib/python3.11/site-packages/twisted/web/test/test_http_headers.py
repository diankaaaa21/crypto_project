...
class NameEncoderTests(SynchronousTestCase):
    ...
    def test_encodeName(self) -> None:
        ...
        self.assertEqual(_nameEncoder.encode(
...
class UnicodeHeadersTests(TestCase):
    ...
    def test_nameNotToken(self) -> None:
        ...
        self.assertRaises(InvalidHeaderName,
                          h.setRawHeaders, b"\xe1", [b"val"])
        self.assertRaises(InvalidHeaderName, h.setRawHeaders,
                          "\u00e1", [b"val"])
    ...
    def test_copy(self) -> None:
        ...
        self.assertEqual(h.getRawHeaders(b"test"), [
