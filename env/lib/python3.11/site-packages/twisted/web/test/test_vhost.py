...
class NameVirtualHostTests(TestCase):
    ...
    def test_renderWithoutHost(self):
        ...
        self.assertEqual(virtualHostResource.render(
            request), b"correct result")
    ...
    def test_renderWithHost(self):
        ...
        requestWithPort.requestHeaders.addRawHeader(
            b"host", b"example.org:8000")
    ...
    def test_getChild(self):
        ...
        self.assertIsInstance(
            virtualHostResource.getChild(b"", request), NoResource)
