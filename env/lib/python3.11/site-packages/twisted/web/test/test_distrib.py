...
class DistribTests(TestCase):
    ...
    def testDistrib(self):
        ...
        self.sub = distrib.ResourceSubscription(
            "127.0.0.1", self.port1.getHost().port)
    ...
    def test_requestHeaders(self):
        ...
        def check_logs():
            ...
            self.assertIn(
                "could not connect to distributed web service: {msg}", msgs)
...
class UserDirectoryTests(TestCase):
    ...
    def setUp(self):
        self.alice = ("alice", "x", 123, 456, "Alice,,,",
                      self.mktemp(), "/bin/sh")
    ...
    def test_invalidMethod(self):
        ...
        request.method = "POST"
        self.assertRaises(server.UnsupportedMethod,
                          self.directory.render, request)
    ...
    def test_render(self):
        ...
        def cbRendered(ignored):
            ...
            self.assertEqual(
                bob.firstChild.getAttribute("href"), "bob.twistd/")
