...
class HTTP1_0Tests(unittest.TestCase, ResponseTestMixin):
    ...
    def test_transportForciblyClosed(self):
        ...
        event = logObserver[1]
        self.assertEquals(
            "Forcibly timing out client: {peer}", event["log_format"])
...
class PipeliningBodyTests(unittest.TestCase, ResponseTestMixin):
    ...
    def test_immediateABiggerTruck(self):
        ...
        self.assertResponseEquals(
            b.value(), self.expectedResponses * overLimitCount)
...
class ChunkedTransferEncodingTests(unittest.TestCase):
    ...
    def test_empty(self):
        ...
        for s in iterbytes(b"3\r\nabc\r\n5\r\n12345\r\n0\r\n\r\n"):
            ...
            p.dataReceived(b"")
        self.assertEqual(
            chunks, [b"a", b"b", b"c", b"1", b"2", b"3", b"4", b"5"])
        self.assertEqual(finished, [b""])
    ...
    def test_extensionsMalformed(self):
        ...
        for b in invalidControl + invalidDelimiter + invalidDel:
            ...
            self.assertRaises(http._MalformedChunkedDataError,
                              p.dataReceived, data)
    ...
    def runChunkedRequest(self, httpRequest, requestFactory=None, chunkSize=1):
        ...
        for pos in range(len(body) // chunkSize + 1):
            ...
            channel.dataReceived(
                b"".join(http.toChunk(
                    body[pos * chunkSize: (pos + 1) * chunkSize]))
            )
...
"""
        ...
        self.assertEqual(args, [[b"value"], [b""], [
                         b"two words", b"more words"]])
...
"""
        ...
        channel = self.runRequest(req.encode(
            "ascii") + body, MyRequest, success=False)
        self.assertEqual(channel.transport.value(),
                         b"HTTP/1.0 200 OK\r\n\r\ndone")
        self.assertEqual(len(processed), 1)
...
class QueryArgumentsTests(unittest.TestCase):
    def test_urlparse(self):
        ...
        def assertSameParsing(url, decode):
            ...
            self.assertEqual((scheme, netloc, path, params,
...
class RequestTests(unittest.TestCase, ResponseTestMixin):
    ...
    def test_setHost(self):
        ...
        self.assertEqual(req.requestHeaders.getRawHeaders(
    ...
    def test_setHeader(self):
        ...
        self.assertEqual(
            req.responseHeaders.getRawHeaders(b"test"), [b"lemur"])
    ...
    def _checkCookie(self, expectedCookieValue, *args, **kwargs):
        ...
        addCookieLines = [
            x for x in writtenLines if x.startswith(b"Set-Cookie")]
    ...
    def test_addCookieSameSite(self):
        ...
        """
        self._checkCookie(b"foo=bar; SameSite=lax",
                          b"foo", b"bar", sameSite="lax")
        self._checkCookie(b"foo=bar; SameSite=lax",
                          b"foo", b"bar", sameSite="Lax")
        self._checkCookie(
    ...
    def test_registerProducerTwiceFails(self):
        ...
        self.assertRaises(ValueError, req.registerProducer,
                          DummyProducer(), True)
