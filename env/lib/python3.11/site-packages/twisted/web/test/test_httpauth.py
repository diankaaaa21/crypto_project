...
class BasicAuthTestsMixin:
    ...
    def makeRequest(self, method=b"GET", clientAddress=None):
        ...
        raise NotImplementedError(
            f"{self.__class__!r} did not implement makeRequest")
    ...
    def test_interface(self):
        ...
        self.assertTrue(verifyObject(
            ICredentialFactory, self.credentialFactory))
...
class HTTPAuthHeaderTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.avatar.putChild(self.childName, Data(
            self.childContent, "text/plain"))
    ...
    def test_unexpectedDecodeError(self):
        ...
        self.assertIsInstance(
            logObserver[0]["log_failure"].value, UnexpectedException)
