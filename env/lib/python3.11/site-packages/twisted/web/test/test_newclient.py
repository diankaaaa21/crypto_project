...
class HTTPClientParserTests(TestCase):
    ...
    def _noBodyTest(self, request, status, response):
        ...
        protocol.response._bodyDataFinished = lambda: bodyDataFinished.append(
            True)
    ...
    def test_responseHeaders(self):
        ...
        self.assertEqual(protocol.response.headers,
    ...
    def test_multipleDistinctContentLengthHeaders(self):
        ...
        """
        protocol = HTTPClientParser(
            Request(b"GET", b"/", _boringHeaders, None), None)
    ...
    def test_ignored1XXResponseCausesLog(self):
        ...
        self.assertEquals(1, len(logObserver))
        event = logObserver[0]
        self.assertEquals(event["log_format"],
...
class HTTP11ClientProtocolTests(TestCase):
    ...
    def test_secondRequest(self):
        ...
        d = self.assertFailure(self.protocol.request(
            SimpleRequest()), RequestNotSent)
    ...
    def assertCancelDuringBodyProduction(self, producerLength):
        ...
        result = protocol.request(
            Request(b"POST", b"/bar", _boringHeaders, producer))
...
class RequestTests(TestCase):
    ...
    def test_sendRequestHeaders(self):
        ...
        """
        headers = Headers(
            {b"x-foo": [b"bar", b"baz"], b"host": [b"example.com"]})
        ...
        self.assertEqual(
            lines,
            [b"Connection: close", b"Host: example.com",
    ...
    def test_sanitizeLinearWhitespaceInRequestHeaders(self):
        ...
        for component in bytesLinearWhitespaceComponents:
            headers = Headers(
                {b"x-foo": [component], b"host": [b"example.invalid"]})
            transport = StringTransport()
...
class RequestBodyConsumerTests(TestCase):
    ...
    def test_interface(self):
        ...
        self.assertTrue(verifyObject(
            IConsumer, ChunkedEncoder(StringTransport())))
...
class TransportProxyProducerTests(TestCase):
    ...
    def test_interface(self):
        ...
        """
        self.assertTrue(verifyObject(
            IPushProducer, TransportProxyProducer(None)))
