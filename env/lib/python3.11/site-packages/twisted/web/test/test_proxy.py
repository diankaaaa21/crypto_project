...
class ProxyClientTests(TestCase):
    ...
    def _testDataForward(
        ...
        # Fake an answer
        client.dataReceived(self.makeResponseBytes(
    ...
    def test_contentLength(self):
        ...
        return self._testDataForward(
            200, b"OK", [
                (b"Content-Length", [str(len(data)).encode("ascii")])], data
        )
...
class ProxyClientFactoryTests(TestCase):
    ...
    def test_buildProtocol(self):
        ...
        factory = ProxyClientFactory(
            b"GET", b"/foo", b"HTTP/1.0", {
                b"accept": b"text/html"}, b"Some data", None
        )
...
class ProxyRequestTests(TestCase):
    ...
    def _testProcess(self, uri, expectedURI, method=b"GET", data=b""):
        ...
        request.requestReceived(
            method, b"http://example.com" + uri, b"HTTP/1.0")
    ...
    def test_processWithPort(self):
        ...
        request.gotLength(0)
        request.requestReceived(
            b"GET", b"http://example.com:1234/foo/bar", b"HTTP/1.0")
