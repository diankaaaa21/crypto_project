...
class ElementTests(TestCase):
    ...
    def test_missingTemplateLoaderRepr(self) -> None:
        ...
        self.assertIn(
            "Pretty Repr Element", repr(
                MissingTemplateLoader(PrettyReprElement()))
        )
    ...
    def test_missingRendererMethod(self) -> None:
        ...
        """
        element = Element()
        err = self.assertRaises(MissingRenderMethod,
                                element.lookupRenderMethod, "foo")
        self.assertIdentical(err.element, element)
    ...
    def test_renderGetDirectlyError(self) -> None:
        ...
        """
        self.assertRaises(UnexposedMethodError,
                          renderer.get, None, "notARenderer")
...
class XMLFileReprTests(TestCase):
    ...
    def test_filename(self) -> None:
        ...
        self.assertEqual(f"<XMLFile of {fname!r}>", repr(
            XMLFile(fname)))  # type: ignore[arg-type]
    ...
    def test_file(self) -> None:
        ...
        self.assertEqual(f"<XMLFile of {fobj!r}>", repr(
            XMLFile(fobj)))  # type: ignore[arg-type]
...
class FlattenIntegrationTests(FlattenTestCase):
    ...
    def test_synchronousDeferredRecursion(self) -> None:
        ...
        """
        self.assertFlattensImmediately(
            [succeed("x") for i in range(250)], b"x" * 250)
    ...
    def test_elementContainingStaticElement(self) -> None:
        ...
        self.assertFlattensImmediately(
            element, b"<p><em>Hello, world.</em></p>")
...
class RenderElementTests(TestCase):
    ...
    def test_simpleRender(self) -> Deferred[None]:
        ...
        self.assertIdentical(
            NOT_DONE_YET, renderElement(self.request, element))
    ...
    def test_simpleFailureWithTraceback(self) -> Deferred[None]:
        ...
        def check(_: object) -> None:
            ...
            self.assertEqual(
                b"".join(
                    self.request.written), b"<!DOCTYPE html>\n<p>I failed.</p>"
            )
            self.assertTrue(self.request.finished)
