...
from twisted.web.http import NO_CONTENT, NOT_MODIFIED, HTTPFactory
from twisted.web.http import Request as _HTTPRequest
from twisted.web.http import datetimeToString, unquote
    ...
    def getSession(self, sessionInterface=None, forceNotSecure=False):
        ...
        if session is None:
            ...
            if not session:
                ...
                self.addCookie(cookiename, session.uid,
                               path=b"/", secure=secure)
