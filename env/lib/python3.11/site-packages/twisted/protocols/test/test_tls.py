...
try:
    ...
    TLS_METHOD = TLSv1_METHOD = TLSv1_1_METHOD = TLSv1_2_METHOD = None
else:
...
class TLSMemoryBIOTests(TestCase):
    ...
    def test_writeUnicodeRaisesTypeError(self):
        ...
        def flush_logged_errors():
            self.assertEqual(
                len(self.flushLoggedErrors(ConnectionLost, TypeError)), 2)
    ...
    def test_loseConnectionAfterHandshake(self):
        ...
        class NotifyingProtocol(ConnectionLostNotifyingProtocol):
            def __init__(self, onConnectionLost):
                ConnectionLostNotifyingProtocol.__init__(
    ...
    def test_connectionLostOnlyAfterUnderlyingCloses(self):
        ...
        wrapperFactory = TLSMemoryBIOFactory(
            ClientTLSContext(), True, ClientFactory())
    ...
    def test_errorWriting(self):
        ...
        class Wrapper:
            ...
            def send(self, *args):
                raise Error(
                    [("SSL routines", "", "this message is probably useless")])
