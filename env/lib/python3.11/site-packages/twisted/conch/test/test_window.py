...
class SelectionTests(TestCase):
    ...
    def test_selectionDownArrow(self) -> None:
        ...
        """
        self.widget.keystrokeReceived(
            ServerProtocol.DOWN_ARROW, None)  # type: ignore[attr-defined]
    ...
    def test_selectionUpArrow(self) -> None:
        ...
        """
        self.widget.keystrokeReceived(
            ServerProtocol.UP_ARROW, None)  # type: ignore[attr-defined]
    ...
    def test_selectionPGDN(self) -> None:
        ...
        """
        self.widget.keystrokeReceived(
            ServerProtocol.PGDN, None)  # type: ignore[attr-defined]
    ...
    def test_selectionPGUP(self) -> None:
        ...
        """
        self.widget.keystrokeReceived(
            ServerProtocol.PGUP, None)  # type: ignore[attr-defined]
