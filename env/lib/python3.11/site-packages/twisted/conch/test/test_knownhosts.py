...
class PlainEntryTests(EntryTestsMixin, TestCase):
    ...
    def test_toString(self) -> None:
        ...
        """
        self.assertEqual(self.entry.toString(),
                         self.plaintextLine.rstrip(b"\n"))
...
class HashedEntryTests(EntryTestsMixin, ComparisonTestsMixin, TestCase):
    ...
    def test_equality(self) -> None:
        ...
        self.assertNormalEqualityImplementation(
            ...
            duplicate,
            HashedEntry(
                hostSalt, hostHash, keyType, Key.fromString(
                    otherSampleKey), comment
            ),
        )
...
class ParseErrorTests(TestCase):
    ...
    def badKeyTest(self, cls: type[HashedEntry | PlainEntry], prefix: bytes) -> None:
        ...
        self.assertRaises(
            ...
            b" ".join(
                [prefix, b"ssh-rsa",
                    b2a_base64(b"Hey, this isn't an SSH key!").strip()]
            ),
        )
    ...
    def test_hashedNotBase64(self) -> None:
        ...
        self.assertRaises(
            ...
            HashedEntry.fromString,
            b" ".join(
                [HashedEntry.MAGIC + b2a_base64(b"stuff").strip() + b"|x", b, c]),
        )
...
class KnownHostsDatabaseTests(TestCase):
    ...
    def test_hasPresentKey(self):
        ...
        hostsFile = self.loadSampleHostsFile()
        self.assertTrue(
            hostsFile.hasHostKey(b"www.twistedmatrix.com",
    ...
    def test_notPresentKey(self):
        ...
        hostsFile = self.loadSampleHostsFile()
        self.assertFalse(
            hostsFile.hasHostKey(b"non-existent.example.com",
                                 Key.fromString(sampleKey))
        )
        self.assertTrue(
            hostsFile.hasHostKey(b"www.twistedmatrix.com",
    ...
    def test_randomSalts(self):
        ...
        self.assertNotEqual(
            ...
            hostsFile.addHostKey(
                b"somewhere-else.example.com", aKey)._hostSalt,
        )
    ...
    def test_verifyNonPresentKey_Yes(self):
        ...
        self.assertEqual(
            True, reloaded.hasHostKey(
                b"4.3.2.1", Key.fromString(thirdSampleKey))
        )
        self.assertEqual(
            True,
            reloaded.hasHostKey(
