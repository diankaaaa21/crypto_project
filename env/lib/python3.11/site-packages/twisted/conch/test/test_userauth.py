...
class SSHUserAuthServerTests(unittest.TestCase):
    ...
    def test_successfulPasswordAuthentication(self):
        ...
        """
        packet = b"".join(
            [NS(b"foo"), NS(b"none"), NS(b"password"), b"\0", NS(b"foo")])
    ...
    def test_failedPasswordAuthentication(self):
        ...
        packet = b"".join(
            [NS(b"foo"), NS(b"none"), NS(b"password"), b"\0", NS(b"bar")])
...
class SSHUserAuthClientTests(unittest.TestCase):
    ...
    def test_publickey_without_privatekey(self):
        ...
        'none' authentication.
        """
        authClient = ClientAuthWithoutPrivateKey(
            b"foo", FakeTransport.Service())
    ...
    def test_defaults(self):
        ...
        """
        authClient = userauth.SSHUserAuthClient(
            b"foo", FakeTransport.Service())
