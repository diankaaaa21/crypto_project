...
class TestAvatar:
    ...
    def lookupChannel(self, channelType, windowSize, maxPacket, data):
        ...
        if channelType == TestChannel.name:
            ...
            # order right.
            raise error.ConchError(self._ARGS_ERROR_CODE,
...
class ConnectionTests(unittest.TestCase):
    ...
    def _openChannel(self, channel):
        ...
        self.conn.ssh_CHANNEL_OPEN_CONFIRMATION(
            struct.pack(">2L", channel.id, 255) +
            b"\x00\x02\x00\x00\x00\x00\x80\x00"
        )
    ...
    def test_GLOBAL_REQUEST(self):
        ...
        self.conn.ssh_GLOBAL_REQUEST(
            common.NS(b"TestData") + b"\xff" + b"test data")
        self.assertEqual(
            self.transport.packets, [
    ...
    def _lookupChannelErrorTest(self, code):
        ...
        self.assertEqual(
            len(errors), 1, f"Expected one error, got: {errors!r}")
    ...
    def test_CHANNEL_WINDOW_ADJUST(self):
        ...
        self.conn.ssh_CHANNEL_WINDOW_ADJUST(
            b"\x00\x00\x00\x00\x00\x00\x00" b"\x01")
        ...
        self.assertEqual(
            ...
            [
                (connection.MSG_GLOBAL_REQUEST,
                 common.NS(b"wantReply") + b"\xffdata"),
