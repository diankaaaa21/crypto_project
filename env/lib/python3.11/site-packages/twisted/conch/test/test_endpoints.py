...
class SSHCommandClientEndpointTestsMixin:
    ...
    def record(self, server, protocol, event, noArgs=False):
        ...
        recorder = []
        if noArgs:
            def f(): return recorder.append(None)
        else:
            f = recorder.append
...
class NewConnectionTests(TestCase, SSHCommandClientEndpointTestsMixin):
    ...
    def setUp(self):
        ...
        self.knownHosts.addHostKey(
            networkString(
                self.serverAddress.host), self.factory.publicKeys[b"ssh-rsa"]
        )
...
class ExistingConnectionHelperTests(TestCase):
    ...
    def test_interface(self):
        ...
        self.assertTrue(verifyClass(
            _ISSHConnectionCreator, _ExistingConnectionHelper))
