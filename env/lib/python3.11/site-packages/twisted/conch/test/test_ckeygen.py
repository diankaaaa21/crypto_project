...
class KeyGenTests(TestCase):
    ...
    def test_saveKey(self) -> None:
        ...
        _saveKey(key, {"filename": filename,
                 "pass": "passphrase", "format": "md5-hex"})
        self.assertEqual(
            self.stdout.getvalue(),
        ...
        self.assertEqual(
            key.fromString(base.child("id_rsa").getContent(),
                           None, "passphrase"), key
        )
        self.assertEqual(
    ...
    def test_saveKeyECDSA(self) -> None:
        ...
        self.assertEqual(
            Key.fromString(base.child(
                "id_ecdsa.pub").getContent()), key.public()
        )
    ...
    def test_saveKeyEd25519(self) -> None:
        ...
        self.assertEqual(
            key.fromString(base.child("id_ed25519").getContent(),
                           None, "passphrase"),
            key,
        )
        self.assertEqual(
            Key.fromString(base.child(
                "id_ed25519.pub").getContent()), key.public()
        )
    ...
    def test_saveKeyECDSAEmptyPassphrase(self) -> None:
        ...
        self.assertEqual(key.fromString(
            base.child("id_ecdsa").getContent(), None), key)
    ...
    def test_saveKeyNoFilename(self) -> None:
        ...
        self.patch(twisted.conch.scripts.ckeygen,
                   "_inputSaveFile", lambda _: keyPath)
        key = Key.fromString(privateRSA_openssh)
        _saveKey(
            key,
    ...
    def test_saveKeyFileExists(self) -> None:
        ...
        key = Key.fromString(privateRSA_openssh)
        options = {"filename": keyPath,
                   "no-passphrase": True, "format": "md5-hex"}
    ...
    def test_saveKeySubtypeV1(self) -> None:
        ...
        self.assertEqual(key.fromString(
            privateKeyContent, None, "passphrase"), key)
        self.assertTrue(
    ...
    def test_changePassphraseEmptyGetPass(self) -> None:
        ...
        filename = self.mktemp()
        FilePath(filename).setContent(privateRSA_openssh_encrypted)
        error = self.assertRaises(SystemExit, changePassPhrase, {
                                  "filename": filename})
        self.assertEqual(
    ...
    def test_displayPublicKeyHandleFileNotFound(self) -> None:
        ...
        self.assertIn(
            "could not be opened, please specify a file.", exc.args[0])
