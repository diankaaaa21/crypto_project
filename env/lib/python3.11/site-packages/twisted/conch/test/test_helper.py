...
class BufferTests(unittest.TestCase):
    ...
    def test_resetPrivateModes(self) -> None:
        ...
        """
        expected = self.term.privateModes.copy()
        self.term.resetPrivateModes(
            [privateModes.AUTO_WRAP, privateModes.CURSOR_MODE])
    ...
    def testSimpleWriting(self) -> None:
        s = b"Hello, world."
        self.term.write(s)
        self.assertEqual(self.term.__bytes__(), s +
                         b"\n" + b"\n" * (HEIGHT - 2))
    ...
    def testEraseToLineBeginning(self) -> None:
        ...
        self.assertEqual(
            self.term.__bytes__(), s[-4:].rjust(len(s)) +
            b"\n" + b"\n" * (HEIGHT - 2)
        )
...
class CharacterAttributeTests(unittest.TestCase):
    ...
    def test_equality(self) -> None:
        ...
        self.assertNotEqual(
            helper.CharacterAttribute(
                bold=True), helper.CharacterAttribute(bold=False)
        )
