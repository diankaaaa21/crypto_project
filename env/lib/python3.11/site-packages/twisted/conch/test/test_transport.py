...
class BaseSSHTransportTests(BaseSSHTransportBaseCase, TransportTestCase):
    ...
    def test_sendVersion(self):
        ...
        self.assertEqual(version, b"SSH-2.0-Twisted_" +
                         twisted_version.encode("ascii"))
    ...
    def test_dataReceiveVersionNotSentMemoryDOS(self):
        ...
        self.assertIn(b"Preventing a denial of service attack",
    ...
    def test_sendKexInit(self):
        ...
        self.assertEqual(
            keyExchanges, b",".join(
                self.proto.supportedKeyExchanges + [b"ext-info-s"])
        )
        ...
        self.assertEqual(compressions1, b",".join(
            self.proto.supportedCompressions))
        self.assertEqual(compressions2, b",".join(
            self.proto.supportedCompressions))
    ...
    def test_receiveDebug(self):
        ...
        self.assertEqual(
            self.proto.debugs, [(True, b"test", b"en"),
                                (False, b"silent", b"en")]
        )
    ...
    def test_receiveUnimplemented(self):
        ...
        """
        self.proto.dispatchMessage(
            transport.MSG_UNIMPLEMENTED, b"\x00\x00\x00\xff")
...
"""
    ...
    def test_dataReceivedSSHVersionUnixNewline(self):
        ...
        self.assertEqual(sut.otherVersionString,
...
class BaseSSHTransportDHGroupExchangeBaseCase(BaseSSHTransportBaseCase):
    ...
    def test_getKey(self):
        ...
        k1 = self.hashProcessor(b"AB" + b"CD" + b"K" +
                                self.proto.sessionID).digest()
        ...
        self.assertEqual(self.proto._getKey(
            b"K", b"AB", b"CD"), k1 + k2 + k3 + k4)
...
class ServerSSHTransportBaseCase(ServerAndClientSSHTransportBaseCase):
    ...
    klass: Optional[Type[transport.SSHTransportBase]
...
class ServerSSHTransportTests(ServerSSHTransportBaseCase, TransportTestCase):
    ...
    def test__getHostKeys(self):
        ...
        self.assertRaises(KeyError, self.proto._getHostKeys,
    ...
    def test_KEXDH_INIT_GROUP14(self):
        ...
        self.assertKexDHInitResponse(
            b"diffie-hellman-group14-sha1", b"ssh-rsa", 2048)
    ...
    def test_keySetup(self):
        ...
        self.assertEqual(
            ...
            (newKeys[1], newKeys[3], newKeys[0],
             newKeys[2], newKeys[5], newKeys[4]),
        )
...
class ServerSSHTransportDHGroupExchangeBaseCase(ServerSSHTransportBaseCase):
    ...
    def test_KEX_DH_GEX_REQUEST_OLD_badKexAlg(self):
        ...
        self.assertRaises(
            ConchError, self.proto.ssh_KEX_DH_GEX_REQUEST_OLD, None)
...
class ClientSSHTransportBaseCase(ServerAndClientSSHTransportBaseCase):
    ...
    def verifyHostKey(self, pubKey, fingerprint):
        ...
        self.assertEqual(
            fingerprint.replace(b":", b""), binascii.hexlify(
                md5(pubKey).digest())
        )
...
class ClientSSHTransportTests(ClientSSHTransportBaseCase, TransportTestCase):
    ...
    def assertKexInitResponseForDH(self, kexAlgorithm, bits):
        ...
        self.assertEqual(
            self.packets, [(transport.MSG_KEXDH_INIT,
    ...
    def test_keySetup(self):
        ...
        self.assertEqual(
            self.proto.nextEncryptions.keys,
            (newKeys[0], newKeys[2], newKeys[1],
             newKeys[3], newKeys[4], newKeys[5]),
        )
    ...
    def test_disconnectKEX_ECDH_REPLYBadSignature(self):
        ...
        self.proto.ecPriv = ec.generate_private_key(
...
class GetMACTests(TestCase):
    ...
    def test_hmacsha2512(self):
        ...
        """
        self.assertGetMAC(b"hmac-sha2-512", sha512,
                          digestSize=64, blockPadSize=64)
    ...
    def test_hmacsha2384(self):
        ...
        value of the key supplied.
        """
        self.assertGetMAC(b"hmac-sha2-384", sha384,
                          digestSize=48, blockPadSize=80)
    ...
    def test_hmacsha2256(self):
        ...
        value of the key supplied.
        """
        self.assertGetMAC(b"hmac-sha2-256", sha256,
                          digestSize=32, blockPadSize=32)
...
class SSHCiphersTests(TestCase):
    ...
    def test_setKeysCiphers(self):
        ...
        for cipName in transport.SSHTransportBase.supportedCiphers:
            ...
            encCipher = transport.SSHCiphers(
                cipName, b"none", b"none", b"none")
            decCipher = transport.SSHCiphers(
                b"none", cipName, b"none", b"none")
    ...
    def test_makeMAC(self):
        ...
        for key, data, mac in vectors:
            outMAC = transport.SSHCiphers(
                b"none", b"none", b"hmac-md5", b"none")
