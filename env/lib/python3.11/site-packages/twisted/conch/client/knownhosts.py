...
class HashedEntry(_BaseEntry, FancyEqMixin):
    ...
    compareAttributes = ("_hostSalt", "_hostHash",
                         "keyType", "publicKey", "comment")
    ...
    def fromString(cls, string: bytes) -> HashedEntry:
        ...
        self = cls(a2b_base64(hostSalt), a2b_base64(
            hostHash), keyType, key, comment)
        return self
    ...
    def toString(self):
        ...
        fields = [
            self.MAGIC
            + b"|".join([_b64encode(self._hostSalt),
...
class KnownHostsFile:
    ...
    def addHostKey(self, hostname: bytes, key: Key) -> HashedEntry:
        ...
        keyType = key.sshType()
        entry = HashedEntry(salt, _hmacedString(
            salt, hostname), keyType, key, None)
