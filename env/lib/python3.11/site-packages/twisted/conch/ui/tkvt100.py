...
class VT100Frame(Tkinter.Frame):
    def __init__(self, *args, **kw):
        ...
        fontWidth = max(
            map(ttyFont.measure, string.ascii_letters + string.digits))
        ...
        self.ansiParser = ansi.AnsiParser(
            ansi.ColorText.WHITE, ansi.ColorText.BLACK)
    ...
    def _write(self, ch, fg, bg):
        ...
        items = self.canvas.find_overlapping(
            canvasX, canvasY, canvasX + 2, canvasY + 2)
        if items:
