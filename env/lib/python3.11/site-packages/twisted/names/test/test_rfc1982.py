...
class SerialNumberTests(unittest.TestCase):
    ...
    def test_unixEpoch(self):
        ...
        the UNIX epoch.
        """
        self.assertEqual(SerialNumber(
            0).toRFC4034DateString(), "19700101000000")
    ...
    def test_Y2106Problem(self):
        ...
        """
        self.assertEqual(
            SerialNumber(-1).toRFC4034DateString(), "21060207062815")
    ...
    def test_Y2038Problem(self):
        ...
        self.assertRaises(
            ArithmeticError, lambda: SerialNumber(
                0) + SerialNumber(maxAddTime + 1)
        )
...
class SerialNumber8BitTests(unittest.TestCase):
    ...
    def test_add(self):
        ...
        """
        self.assertEqual(serialNumber8(255) +
                         serialNumber8(1), serialNumber8(0))
        self.assertEqual(serialNumber8(100) +
                         serialNumber8(100), serialNumber8(200))
        self.assertEqual(serialNumber8(200) +
                         serialNumber8(100), serialNumber8(44))
    ...
    def test_surprisingAddition(self):
        ...
        """
        self.assertTrue(serialNumber8(100) + serialNumber8(100)
                        > serialNumber8(100))
        self.assertTrue(
