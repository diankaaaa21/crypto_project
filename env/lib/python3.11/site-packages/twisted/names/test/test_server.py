...
def assertLogMessage(testCase, expectedMessages, callable, *args, **kwargs):
    ...
    testCase.assertEqual([m["message"][0]
                         for m in loggedMessages], expectedMessages)
...
class DNSServerFactoryTests(unittest.TestCase):
    ...
    def test_resolverType(self):
        ...
        self.assertIsInstance(
            server.DNSServerFactory().resolver, resolve.ResolverChain)
    ...
    def test_resolverOrder(self):
        ...
        self.assertEqual(
            server.DNSServerFactory(
                authorities=[DummyAuthority], caches=[
                    DummyCache], clients=[DummyClient]
            ).resolver.resolvers,
    ...
    def test_canRecurseOverride(self):
        ...
        """
        self.assertEqual(server.DNSServerFactory(
            clients=[None]).canRecurse, True)
