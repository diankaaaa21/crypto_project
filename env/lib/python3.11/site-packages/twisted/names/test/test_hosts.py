...
class SearchHostsFileTests(SynchronousTestCase, GoodTempPathMixin):
    ...
    def test_findAddress(self) -> None:
        ...
        self.assertEqual("10.2.3.4", searchFileFor(
            hosts.path, b"foo.example.com"))
    ...
    def test_searchFileForAliases(self) -> None:
        ...
        self.assertEqual(searchFileFor(
            hosts.path, b"helmut.example.org"), "127.0.1.1")
...
class SearchHostsFileForAllTests(SynchronousTestCase, GoodTempPathMixin):
    ...
    def test_caseInsensitively(self) -> None:
        ...
        self.assertEqual(["127.0.0.1"], searchFileForAll(
            hosts, b"FOOBAR.example.com"))
...
"""
    ...
    def test_lookupIPV6Address(self) -> None:
        ...
        self.assertEqual(
            (
                RRHeader(
                    b"ip6-multiple", AAAA, IN, self.ttl, Record_AAAA(
                        "::3", self.ttl)
                ),
                RRHeader(
                    b"ip6-multiple", AAAA, IN, self.ttl, Record_AAAA(
    ...
    def test_lookupAddressNotFound(self) -> None:
        ...
        """
        self.failureResultOf(
            self.resolver.lookupAddress(b"foueoa"), DomainError)
    ...
    def test_lookupIPV6AddressNotFound(self) -> None:
        ...
        """
        self.failureResultOf(
            self.resolver.lookupIPV6Address(b"foueoa"), DomainError)
    ...
    def test_lookupAllRecordsNotFound(self) -> None:
        ...
        """
        self.failureResultOf(
            self.resolver.lookupAllRecords(b"foueoa"), DomainError)
