...
test_domain_com = NoFileAuthority(
    ...
    records={
        b"test-domain.com": [
            ...
            dns.Record_A6(
                8, b"0:5634:1294:AFCB:56AC:48EF:34C3:01FF", b"tra.la.la.net"),
...
my_domain_com = NoFileAuthority(
    ...
    records={
        b"my-domain.com": [
            ...
            dns.Record_SRV(257, 16383, 43690,
                           b"some.other.place.fool", ttl="4D"),
        ]
    },
)
...
class ServerDNSTests(unittest.TestCase):
    ...
    def test_SRV(self):
        ...
        return self.namesTest(
            ...
            [dns.Record_SRV(257, 16383, 43690,
                            "some.other.place.fool", ttl=19283784)],
        )
    ...
    def test_spf(self):
        ...
        return self.namesTest(
            ...
            [
                dns.Record_SPF(
                    b"v=spf1 mx/30 mx:example.org/30 -all", ttl=19283784),
                dns.Record_SPF(
                    b"v=spf1 +mx a:\0colo",
                    b".example.com/28 -all not valid",
                    ttl=19283784,
    ...
    def test_AAAA(self):
        ...
        return self.namesTest(
            ...
            [dns.Record_AAAA(
                "AF43:5634:1294:AFCB:56AC:48EF:34C3:01FF", ttl=19283784)],
        )
    ...
    def test_A6(self):
        ...
        return self.namesTest(
            ...
            [
                ...
                dns.Record_A6(12, "0:0069::0",
                              "some.network.tld", ttl=19283784),
                dns.Record_A6(
                    8,
        ...
        self.records = [
            ...
            dns.RRHeader(
                ...
                payload=dns.Record_MX(
                    preference=10, exchange="mail.mv3d.com", ttl=700),
            ),
            dns.RRHeader(
                name="fooby.com",
                type=dns.A,
...
class BindAuthorityTests(unittest.TestCase):
    ...
    def test_invalidRecordClass(self):
        ...
        self.assertEqual("Record type 'LOL' not supported",
                         e.exception.args[0])
