...
class ServiceManager(service.MultiService):
    ...
    def __init__(self, jid, password):
        ...
        # date
        self._xsFactory.addBootstrap(
            xmlstream.STREAM_CONNECTED_EVENT, self._connected)
