...
class HashPasswordTests(unittest.TestCase):
    ...
    def test_sidNotUnicode(self):
        ...
        """
        self.assertRaises(TypeError, xmlstream.hashPassword,
                          b"\xc2\xb92345", "secret")
...
class XmlStreamTests(unittest.TestCase):
    ...
    def test_sendHeaderBasic(self):
        ...
        self.assertIn(
            b"xmlns:stream='http://etherx.jabber.org/streams'", splitHeader)
...
class ConnectAuthenticatorTests(unittest.TestCase):
    def setUp(self):
        ...
        self.xmlstream.addObserver(
            "//event/stream/authd", self.onAuthenticated)
        self.xmlstream.addObserver(
            "//event/xmpp/initfailed", self.onInitFailed)
...
class BaseFeatureInitiatingInitializerTests(unittest.TestCase):
    ...
    def testAdvertized(self):
        ...
        """
        self.xmlstream.features = {
            self.init.feature: domish.Element(self.init.feature)}
...
class StreamManagerTests(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual(
            sm._authd, sm.factory.callbacks["//event/stream/authd"])
