...
class SerializerTests(unittest.TestCase):
    ...
    def testChildOtherDefaultNamespace(self):
        ...
        self.assertEqual(
            e.toXml(), "<foo xmlns='testns'><bar xmlns='testns2'/></foo>")
    ...
    def testQualifiedAttributeDefaultNS(self):
        e = domish.Element(("testns", "foo"), attribs={
                           ("testns", "bar"): "baz"})
        self.assertEqual(
    ...
    def testPrefixScope(self):
        ...
        self.assertEqual(
            e.toXml(prefixes={"testns": "bar"},
                    prefixesInScope=["bar"]), "<bar:foo/>"
        )
    ...
    def testLocalPrefixesWithChild(self):
        ...
        self.assertEqual(
            e.toXml(), "<bar:foo xmlns:bar='testns'><baz/></bar:foo>")
