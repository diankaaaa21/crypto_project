...
class BindInitializerTests(InitiatingInitializerHarness, unittest.TestCase):
    ...
    def testBasic(self):
        ...
        def onBind(iq):
            ...
            response.bind.addElement(
                "jid", content="user@example.com/other resource")
            self.pipe.source.send(response)
...
class BasicAuthenticatorTests(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        xs = client.basicClientFactory(
            self.client_jid, "secret").buildProtocol(None)
