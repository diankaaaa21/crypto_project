...
class ModeParsingTests(IRCTestCase):
    ...
    def test_consecutiveDirection(self):
        ...
        self.assertEqual(
            added, [("s", None), ("n", None), ("t", None), ("i", None)])
        self.assertEqual(removed, [])
    ...
    def test_parameters(self):
        ...
        added, removed = irc.parseModes(
            "+klbb", ["somekey", "42", "nick!user@host",
                      "other!*@*"], self.paramModes
        )
        self.assertEqual(
            added,
            [
...
class FormattedTextTests(IRCTestCase):
    ...
    def test_assembleNested(self):
        ...
        self.assertEqual(
            irc.assembleFormattedText(
                A.normal[
                    A.fg.red[A.bg.green["hello"],
                             " world"], A.reverseVideo[" yay"]
                ]
            ),
    ...
    def test_colorFormatting(self):
        ...
        """
        self.assertEqual(irc.parseFormattedText(
            "\x0301yay\x03"), A.fg.black["yay"])
        self.assertEqual(
            irc.parseFormattedText(
                "\x0301,02yay\x03"), A.fg.black[A.bg.blue["yay"]]
        )
        self.assertEqual(
    ...
    def test_weirdColorFormatting(self):
        ...
        self.assertAssembledEqually(
            "\x031kinda valid", A.fg.black["kinda valid"])
        self.assertAssembledEqually(
...
class FormattingStateAttributeTests(IRCTestCase):
    ...
    def test_equality(self):
        ...
        self.assertEqual(irc._FormattingState(),
...
class ServerSupportedFeatureTests(IRCTestCase):
    ...
    def test_parseChanModesParam(self):
        ...
        self.assertEqual(
            ...
            {"addressModes": "b", "param": "k",
                "setParam": "l", "noParam": "imnpst"},
        )
        ...
        self.assertRaises(ValueError, _parseChanModesParam,
                          ["a", "b", "c", "d", "e"])
    ...
    def test_parse(self):
        ...
        self.assertEqual(supported.getFeature(
            "CHANLIMIT"), [("#", 20), ("&", 10)])
    ...
    def test_support_CHANMODES(self):
        ...
        self.assertEqual(
            ...
            {"addressModes": "A", "param": "Bc",
                "setParam": "Def", "noParam": "Ghij"},
        )
    ...
    def test_support_CHANTYPES(self):
        ...
        self.assertEqual(self._parseFeature(
            "CHANTYPES", "#&%"), ("#", "&", "%"))
...
class CTCPTests(IRCTestCase):
    ...
    def test_noDefaultDispatch(self):
        ...
        self.client.irc_PRIVMSG(
            "foo!bar@baz.quux", ["#chan",
                                 "{X}NOTREAL{X}".format(X=irc.X_DELIM)]
        )
        self.assertEqualBufferValue(self.file.getvalue(), "")
        self.assertEqual(
...
class ClientImplementationTests(IRCTestCase):
    ...
    def testLuserChannels(self):
        args = "7116"
        msg = "channels formed"
        self._serverTestImpl("254", msg, "luserChannels",
                             args=args, channels=int(args))
    ...
    def test_getChannelModeParams(self):
        ...
        def removeFeature(name):
            name = "-" + name
            msg = "are available on this server"
            self._serverTestImpl("005", msg, "isupport",
    ...
    def test_mixedModes(self):
        ...
        self._checkModeChange(
            [(True, "osv", ("a_user", None, "another_user"))])
    ...
    def test_tooManyModeParameters(self):
        ...
        self.assertSubstring("Too many parameters",
    ...
    def test_tooFewModeParameters(self):
        ...
        errors = self.flushLoggedErrors(irc.IRCBadModes)
        self.assertEqual(len(errors), 1)
        self.assertSubstring("Not enough parameters",
                             errors[0].getErrorMessage())
...
class ClientMsgTests(IRCTestCase):
    ...
    def test_newlinesWithinMessage_msg(self):
        ...
        self.assertEqual(self.client.lines, [
                         "PRIVMSG foo :bar", "PRIVMSG foo :baz"])
    ...
    def test_newlinesBeforeLineBreaking(self):
        ...
        self.assertEqual(
            self.client.lines, ["PRIVMSG foo :" +
                                longline, "PRIVMSG foo :" + longline]
        )
    ...
    def test_say(self):
        ...
        self.assertEqual(self.client.lines, [
                         "PRIVMSG #thechannel :the message"])
...
class ClientTests(IRCTestCase):
    ...
    def test_ping(self):
        ...
        for pingNum in range(self.protocol._MAX_PINGRING + 3):
            self.protocol._pings[("otheruser"), (str(
                pingNum))] = time.time() + pingNum
        self.assertEqual(len(self.protocol._pings),
                         self.protocol._MAX_PINGRING + 3)

        # Ping a user
        self.protocol.ping("otheruser", "I sent a lot of pings")
        # The excess pings should have been purged
        self.assertEqual(len(self.protocol._pings),
                         self.protocol._MAX_PINGRING)
        self.assertEqual(
...
class DccTests(IRCTestCase):
    ...
    def setUp(self):
        methods = ["dccDoSend", "dccDoAcceptResume",
                   "dccDoResume", "dccDoChat"]
    ...
    def test_dccAcceptMalformedRequest(self):
        ...
        self.assertEqual(
            str(result), "malformed DCC SEND ACCEPT request: ['foo']")
    ...
    def test_dccResumeMalformedRequest(self):
        ...
        self.assertEqual(
            str(result), "malformed DCC SEND RESUME request: ['foo']")
...
class ServerToClientTests(IRCTestCase):
    ...
    def test_irc_KICK(self):
        ...
        self.client.irc_KICK(
            self.user, [self.channel, "Svadilfari", "hadouken!"])
        self.assertEqual(
            self.client.methods,
            [
    ...
    def test_irc_RPL_TOPIC(self):
        ...
        reported.
        """
        self.client.irc_RPL_TOPIC(
            self.user, ["?", self.channel, "new topic is new"])
        self.assertEqual(
            self.client.methods,
            [("topicUpdated", ("Wolf", self.channel, "new topic is new"))],
        )
