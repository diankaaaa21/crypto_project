...
class IRCProtocolTests(unittest.TestCase):
    ...
    def _assertGreeting(self, user):
        ...
        expected = [irc.RPL_WELCOME, irc.RPL_YOURHOST,
                    irc.RPL_CREATED, irc.RPL_MYINFO]
    ...
    def testJoin(self):
        ...
        somechannel = self.successResultOf(
            self.realm.createGroup("somechannel"))
    ...
    def testLeave(self):
        ...
        self.assertEqual(response[0][1], "PART")
        self.assertEqual(response[0][2], [
                         "#somechannel", "goodbye stupidheads1"])
        self.assertEqual(response, event)
    ...
    def testGetTopic(self):
        ...
        self.assertEqual(
            response[3][2], ["useruser",
                             "#somechannel", "This is a test topic."]
        )
        self.assertEqual(response[4][1], "333")
        self.assertEqual(
            response[4][2], ["useruser", "#somechannel",
                             "some_fellow", "77777777"]
        )
        ...
        self.assertEqual(
            response[0][2], ["useruser",
                             "#somechannel", "This is a test topic."]
        )
        self.assertEqual(response[1][1], "333")
        self.assertEqual(
            response[1][2], ["useruser", "#somechannel",
                             "some_fellow", "77777777"]
        )
    ...
    def testPrivateMessage(self):
        ...
        self.assertEqual(
            response[0][2], ["useruser",
                             "nousernamedthis", "No such nick/channel."]
        )
