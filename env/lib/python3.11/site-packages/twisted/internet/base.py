...
from twisted.internet._resolver import GAIResolver as _GAIResolver
from twisted.internet._resolver import (
...
_systemEventHandler = _log.failureHandler(
    ...
    def _checkTimeout(
        ...
        try:
            ...
            if isinstance(result, Failure):
                userDeferred.errback(self._fail(
...
_ThreePhaseEventTriggerHandle = NewType(
    ...
    Tuple[str, _ThreePhaseEventTriggerCallable,
...
_SystemEventID = NewType(
    "_SystemEventID", Tuple[str, _ThreePhaseEventTriggerHandle])
_ThreadCall = Tuple[Callable[..., Any], Tuple[object, ...], Dict[str, object]]

_DEFAULT_DELAYED_CALL_LOGGING_HANDLER = _log.failureHandler(
...
class BaseConnector(ABC):
    ...
    def getDestination(self) -> IAddress:
        raise NotImplementedError(
            ...
            " did not implement " "getDestination"
        )
