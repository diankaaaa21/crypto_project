...
from twisted.internet._sslverify import OpenSSLDefaultPaths
from twisted.internet._sslverify import OpenSSLCertificateOptions as CertificateOptions
from twisted.internet._sslverify import OpenSSLAcceptableCiphers as AcceptableCiphers
...
class Connector(tcp.Connector):
    def __init__(
        ...
        tcp.Connector.__init__(self, host, port, factory,
                               timeout, bindAddress, reactor)
