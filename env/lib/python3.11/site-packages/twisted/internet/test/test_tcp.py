...
if platform.isWindows():
    ...
    try:
        ...
        def getLinkLocalIPv6Addresses(): return []
    else:
...
class TCPClientTestsBase(ReactorBuilder, ConnectionTestsMixin, StreamClientTestsMixin):
    ...
    def test_addresses(self):
        ...
        boundPort = [host] + list(
            socket.getaddrinfo(self.interface, clientFactory.boundPort)[
                0][-1][1:]
        )
        ...
        self.assertEqual(transportData["host"],
                         self.addressClass("TCP", *boundPort))
        self.assertEqual(transportData["peer"],
...
class TCPConnectorTestsBuilder(ReactorBuilder):
    ...
    def test_connectorIdentity(self):
        ...
        connector = reactor.connectTCP(
            self.interface, portNumber, clientFactory)
...
class TCPPortTestsMixin:
    ...
    def test_buildProtocolIPv4Address(self):
        ...
        self.assertEqual(IPv4Address(
            "TCP", *client.getsockname()), observedAddress)
    ...
    def test_buildProtocolIPv6Address(self):
        ...
        self.assertEqual(IPv6Address(
            "TCP", hostname, peer[1]), observedAddress)
    ...
    def test_serverGetHostOnIPv4(self):
        ...
        self.assertEqual(IPv4Address(
            "TCP", *client.getpeername()), hostAddress)
    ...
    def test_serverGetPeerOnIPv4(self):
        ...
        self.assertEqual(IPv4Address(
            "TCP", *client.getsockname()), peerAddress)
    ...
    def pauseResumeProducing(self, counter):
        ...
        if counter:
            self.factory.reactor.callLater(
                0, self.pauseResumeProducing, counter - 1)
        else:
            self.factory.reactor.callLater(
                0, self.factory.ready.callback, self)
...
class WriteSequenceTestsMixin:
    ...
    def test_writeSequeceWithoutWrite(self):
        ...
        def connected(protocols):
            ...
            client.transport.writeSequence(
                [b"Some ", b"sequence ", b"splitted"])
    ...
    def test_writeSequenceWithUnicodeRaisesException(self):
        ...
        def connected(protocols):
            ...
            exc = self.assertRaises(
                TypeError, server.transport.writeSequence, [
                    "Unicode is not kosher"]
            )
