...
class ErrorsTests(unittest.SynchronousTestCase):
    ...
    def test_socketReadNormal(self) -> None:
        ...
        port.socket = StringUDPSocket(
            [b"result", b"123",
                socket.error(-7000), b"456", socket.error(-7000)]
        )
        port.doRead()
        # Read stops on error:
    ...
    def test_readImmediateError(self) -> None:
        ...
        protocol.connectionRefused = lambda: 1 / \
            0  # type: ignore[method-assign]
    ...
    def test_connectedReadImmediateError(self) -> None:
        ...
        protocol = KeepReads()
        refused = []
        protocol.connectionRefused = lambda: refused.append(
