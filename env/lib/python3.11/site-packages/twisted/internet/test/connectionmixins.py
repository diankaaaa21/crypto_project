...
class ConnectionTestsMixin:
    ...
    def test_writeAfterDisconnect(self):
        ...
        def protocol(): return ClosingLaterProtocol(serverConnectionLostDeferred)
        ...
        def listening(port):
            ...
            def protocol(): return ClosingLaterProtocol(lostConnectionDeferred)
    ...
    def test_disconnectWhileProducing(self):
        ...
        class ClientProtocol(Protocol):
            ...
            def unregister(self):
                ...
                # soon.
                reactor.callLater(
                    1.0, finished.errback, Failure(
                        Exception("Connection was not lost"))
                )
