...
if not TYPE_CHECKING:
    try:
        from os import POSIX_SPAWN_CLOSE as _PS_CLOSE
        from os import POSIX_SPAWN_DUP2 as _PS_DUP2
    except ImportError:
        pass
        ...
        try:
            ...
            if self.pid == 0:
                ...
                try:
                    ...
                    self._execChild(path, uid, gid, executable,
                                    args, environment)
                except BaseException:
...
class Process(_BaseProcess):
    ...
    def __init__(
        ...
        try:
            ...
            self._fork(path, uid, gid, executable,
                       args, environment, fdmap=fdmap)
        except BaseException:
        ...
        for childFD, parentFD in helpers.items():
            ...
            if childFDs[childFD] == "r":
                reader = self.processReaderFactory(
                    reactor, self, childFD, parentFD)
    ...
    def _trySpawnInsteadOfFork(
        ...
        for eachFD in _listOpenFDs():
            try:
                isCloseOnExec = fcntl.fcntl(
                    eachFD, fcntl.F_GETFD, fcntl.FD_CLOEXEC)
            except OSError:
                pass
            else:
