...
class OptionsTests(twisted.trial.unittest.TestCase):
    ...
    def test_synopsis(self) -> None:
        ...
        self.assertTrue(options.getSynopsis().endswith(
    ...
    def _testLogFormat(
        ...
        self.assertIdentical(
            options["fileLogObserverFactory"], expectedObserverFactory)
    ...
    def test_subCommandsIncludeWeb(self) -> None:
        ...
        subCommands = {name for name, shortcut,
                       parser, doc in options.subCommands}
