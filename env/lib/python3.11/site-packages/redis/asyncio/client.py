...
ResponseCallbackT = Union[ResponseCallbackProtocol,
...
class Redis(
    ...
    def __del__(
        ...
        if hasattr(self, "connection") and (self.connection is not None):
            _warn(f"Unclosed client session {self!r}",
...
class PubSub:
    ...
    async def psubscribe(self, *args: ChannelT, **kwargs: PubSubHandler):
        ...
        new_patterns: Dict[ChannelT,
                           PubSubHandler] = dict.fromkeys(parsed_args)
