    ...
    class _TypedDictMeta(type):
        ...
        def __new__(
            ...
            if closed is not None and extra_items is not NoExtraItems:
                raise TypeError(
                    f"Cannot combine closed={closed!r} and extra_items")
...
if hasattr(typing, "ReadOnly"):  # 3.13+
    ...
    def _clean_optional(obj, hints, globalns=None, localns=None):
        ...
        for name, value in hints.items():
            ...
            original_evaluated = typing._eval_type(
                original_value, globalns, localns)
        ...
        def __init__(self, name: str, value, *, type_params=()):
            ...
            for type_param in type_params:
                if (
                    ...
                    raise TypeError(
                        f"Expected a type param, got {type_param!r}")
                has_default = (
                    getattr(type_param, "__default__",
                            NoDefault) is not NoDefault
                )
        ...
        * STRING: return annotations as strings, in a format close to the original
            ...
            if format is Format.STRING:
                return {
                    key: value if isinstance(
                        value, str) else typing._type_repr(value)
        ...
        return_value = {
            key: value if not isinstance(
                value, str) else eval(value, globals, locals)
            for key, value in ann.items()
        }
        return return_value
...
if hasattr(typing, "evaluate_forward_ref"):
    ...
    def _eval_with_owner(
        ...
        if (
            ...
            globals = getattr(
                sys.modules.get(forward_ref.__forward_module__,
                                None), "__dict__", None
            )
        if globals is None:
    ...
    def _lax_type_check(
        ...
        if isinstance(type_, (_SpecialForm, typing._SpecialForm)) or type_ in (
            ...
            raise TypeError(
                f"Plain {type_} is not valid as type argument") from None
        ...
        *type_params* is a tuple of type parameters that are in scope when
        ...
        if sys.version_info < (3, 12, 5):
            return typing._eval_type(
                ...
                globals,
                locals,
                recursive_guard=_recursive_guard | {
