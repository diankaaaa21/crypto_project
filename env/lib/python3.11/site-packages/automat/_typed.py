...
from typing import (TYPE_CHECKING, Any, Callable, Generic, Iterable, Literal,
                    Protocol, TypeVar, get_origin, overload)

if TYPE_CHECKING:
    from graphviz import Digraph
try:
    from zope.interface.interface import \
        InterfaceClass  # type:ignore[import-untyped]
except ImportError:
    hasInterface = False
else:
    hasInterface = True
...
from ._runtimeproto import (ProtocolAtRuntime, _liveSignature,
                            actuallyDefinedProtocolMethods, runtime_name)
