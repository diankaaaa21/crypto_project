...
class UponFromNo(Generic[InputProtocol, Core, P, R]):
    ...
    old: TypedState[InputProtocol,
                    Core] | TypedDataState[InputProtocol, Core, Any, ...]
...
class UponFromData(Generic[InputProtocol, Core, P, R, Data]):
    ...
    def to(
        ...
        Concatenate[InputProtocol, Core, Data,
                    P], Concatenate[InputProtocol, P], R
    ]: ...
...
class TypeMachineBuilder(Generic[InputProtocol, Core]):
    ...
    def state(
        self,
        name: str,
        dataFactory: Callable[Concatenate[InputProtocol,
                                          Core, P], Data] | None = None,
    ...
    def build(self) -> TypeMachine[InputProtocol, Core]:
        ...
        runtimeType: type[InputImplementer[InputProtocol, Core]] = type(
            ...
            {
                method_name: implementMethod(
                    getattr(self.inputProtocol, method_name))
