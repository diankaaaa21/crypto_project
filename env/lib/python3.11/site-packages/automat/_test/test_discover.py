...
class _WritesPythonModules(TestCase):
    ...
    def setUp(self):
        ...
        from twisted.python.modules import PythonPath, getModule
...
class OriginalLocationTests(_WritesPythonModules):
    ...
    def test_failsWithNoModule(self):
        ...
        moduleDict = self.makeModuleAsDict(
            source, self.pathDir, "empty_module_attr.py")
...
class FindMachinesViaWrapperTests(_WritesPythonModules):
    ...
    def test_yieldsMachineInNestedClass(self):
        ...
        """
        moduleDict = self.makeModuleAsDict(
            source, self.pathDir, "nestedcls.py")
    ...
    def test_yieldsMachineInModule(self):
        ...
        self.assertIn(
            ("root.rootMachine", rootMachine), list(
                self.findMachinesViaWrapper(module))
        )
    ...
    def test_ignoresImportedClass(self):
        ...
        self.makeModule(originalSource, self.pathDir, "original.py")
        importingModule = self.makeModule(
            importingSource, self.pathDir, "importing.py")
...
class WrapFQPNTests(TestCase):
    ...
    def setUp(self):
        from twisted.python.modules import PythonAttribute, PythonModule

        from .._discover import InvalidFQPN, NoModule, NoObject, wrapFQPN
