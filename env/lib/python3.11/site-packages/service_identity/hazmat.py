...
from .exceptions import (CertificateError, DNSMismatch, IPAddressMismatch,
                         Mismatch, SRVMismatch, URIMismatch, VerificationError)
    ...
    *obligatory_ids* must be both present and match.  *optional_ids* must match
    ...
    for i in obligatory_ids:
        if i not in matched_ids:
            errors.append(i.error_on_mismatch(mismatched_id=i))  # noqa: PERF401
