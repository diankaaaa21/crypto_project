...
from cryptography.x509 import (Certificate, DNSName, ExtensionOID, IPAddress,
                               ObjectIdentifier, OtherName,
...
from .hazmat import (DNS_ID, CertificatePattern, DNSPattern, IPAddress_ID,
                     IPAddressPattern, SRVPattern, URIPattern,
