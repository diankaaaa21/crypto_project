        ...
        try:
            if state:
                ...
                if unrestored:
                    ...
                    print(RESTORE_PANIC_FMT.format(
                        len(errors), errors), file=stderr)
...
class Message(base.Message):
    ...
    def serializable(self):
        ...
        body, _ = self.channel.encode_body(
            self.body, props.get("body_encoding"))
...
class Channel(AbstractChannel, base.StdChannel):
    ...
    def _reset_cycle(self):
        self._cycle = FairCycle(self._get_and_deliver,
                                self._active_queues, Empty)
