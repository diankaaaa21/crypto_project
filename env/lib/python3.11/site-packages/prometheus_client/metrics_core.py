...
class UnknownMetricFamily(Metric):
    ...
    def __init__(
        ...
        if labels is not None and value is not None:
            raise ValueError(
                "Can only specify at most one of value and labels.")
        if labels is None:
            labels = []
...
class SummaryMetricFamily(Metric):
    ...
    def __init__(
        ...
        if (sum_value is None) != (count_value is None):
            raise ValueError(
                "count_value and sum_value must be provided together.")
...
class HistogramMetricFamily(Metric):
    ...
    def __init__(
        ...
        if labels is not None and buckets is not None:
            raise ValueError(
                "Can only specify at most one of buckets and labels.")
        if labels is None:
            labels = []
        self._labelnames = tuple(labels)
    ...
    def add_metric(
        ...
        for b in buckets:
            ...
            self.samples.append(
                Sample(
                    self.name + "_bucket",
                    dict(list(zip(self._labelnames, labels)) +
                         [("le", bucket)]),
                    value,
                    timestamp,
                    exemplar,
    ...
    def add_metric(
        ...
        self.samples.extend(
            [
                ...
                Sample(self.name + "_gsum", dict(zip(self._labelnames,
                       labels)), gsum_value, timestamp),  # type: ignore
            ]
        )
