...
class Signature(dict):
    ...
    def _stamp_headers(
        ...
        if visitor_headers is not None:
            ...
            if "stamped_headers" not in visitor_headers:
                visitor_headers["stamped_headers"] = list(
                    visitor_headers.keys())
    ...
    def stamp(self, visitor=None, append_stamps=False, **headers):
        ...
        headers = self._stamp_headers(
            visitor_headers, append_stamps, **headers)
...
class _chain(Signature):
    ...
    def __init__(self, *tasks, **options):
        tasks = regen(tasks[0]) if len(
            tasks) == 1 and is_list(tasks[0]) else tasks
    ...
    def run(
        ...
        **options,
        ...
        args = (
            tuple(args) +
            tuple(self.args) if args and not self.immutable else self.args
        )
...
class chunks(Signature):
    ...
    def group(self):
        ...
        return group(
            (xstarmap(task, part, app=self._app)
...
class group(Signature):
    ...
    def apply(self, args=None, kwargs=None, **options):
        ...
        return app.GroupResult(
            group_id,
            [sig.apply(args=args, kwargs=kwargs, **options)
...
class _chord(Signature):
    ...
    def stamp(self, visitor=None, append_stamps=False, **headers):
        ...
        visitor_headers = None
        if visitor is not None:
            visitor_headers = visitor.on_chord_header_start(
                self, **headers) or {}
        headers = self._stamp_headers(
            visitor_headers, append_stamps, **headers)
        self.stamp_links(visitor, append_stamps, **headers)
