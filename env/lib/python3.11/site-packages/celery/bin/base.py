...
class CeleryOption(click.Option):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.default_value_from_context = kwargs.pop(
            "default_value_from_context", None)
...
class CeleryDaemonCommand(CeleryCommand):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.params.append(
            CeleryOption(
                ("-f", "--logfile"),
                help_group="Daemonization Options",
        ...
        self.params.append(CeleryOption(
            ("--uid",), help_group="Daemonization Options"))
        self.params.append(CeleryOption(
            ("--gid",), help_group="Daemonization Options"))
        self.params.append(
