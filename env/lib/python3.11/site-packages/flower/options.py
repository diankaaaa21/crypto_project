...
define("unix_socket", default="", help="path to unix socket to bind", type=str)
...
define("auth", default="", type=str, help="regexp of emails to grant access")
define(
    "basic_auth",
    type=str,
    default=None,
...
define("certfile", type=str, default=None, help="SSL certificate file")
define("keyfile", type=str, default=None, help="SSL key file")
define(
    "xheaders",
    type=bool,
    default=False,
...
define("auto_refresh", default=True, help="refresh workerss", type=bool)
define(
...
define(
    "cookie_secret", type=str, default=token_urlsafe(64), help="secure cookie secret"
)
define("conf", default=DEFAULT_CONFIG_FILE, help="configuration file")
define(
    "enable_events", type=bool, default=True, help="periodically enable Celery events"
)
define(
    "format_task",
...
define(
    ...
    multiple=True,
    help="histogram latency bucket value",
)
